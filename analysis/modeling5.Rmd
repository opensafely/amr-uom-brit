...
df.plot2=df%>% filter(case==1 & br_total_ab_qn_5!="without any ab")%>%group_by(br_total_ab_qn_5)%>%summarise(percent=n())
...
ggplot(data=df.plot, aes(x=case, y=percent, fill=exp.level)) +
