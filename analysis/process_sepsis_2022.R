...
df <- read_csv(here::here("output", "input_sepsis_2022.csv"),
                col_types = col_spec)
...
write_csv(t, here::here("output", "table_sepsis_2022_0.csv"))
...
write_csv(t1, here::here("output", "table_sepsis_2022_1.csv"))
