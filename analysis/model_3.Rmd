...
data=df%>%filter(total_ab_group==1)
mod1=glm(case ~ ab_Level_type + CCI + covrx_ever + bmi_cat + care_home + flu_vaccine + smoking_cat_3 + imd+ ethnicity_6,family="binomial", data)
...
### level2
```{r }
data=df%>%filter(total_ab_group==2)

mod2=glm(case ~ ab_Level_type + CCI + covrx_ever + bmi_cat + care_home + flu_vaccine + smoking_cat_3 + imd+ ethnicity_6,family="binomial", data)
...
### level3
```{r }
data=df%>%filter(total_ab_group==3)

mod3=glm(case ~ ab_Level_type + CCI + covrx_ever + bmi_cat + care_home + flu_vaccine + smoking_cat_3 + imd+ ethnicity_6,family="binomial", data)
...
### level4
```{r }
data=df%>%filter(total_ab_group==4)

mod4=glm(case ~ ab_Level_type + CCI + covrx_ever + bmi_cat + care_home + flu_vaccine + smoking_cat_3 + imd+ ethnicity_6,family="binomial", data)
sum.mod4=summary(mod4)
sum.mod4
```

```{r }
result1=data.frame(sum.mod1$coefficients[2:4])
result2=data.frame(sum.mod2$coefficients[2:4])
result3=data.frame(sum.mod3$coefficients[2:4])
result4=data.frame(sum.mod4$coefficients[2:4])
