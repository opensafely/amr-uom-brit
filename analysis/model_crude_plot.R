...
dfch <- readRDS("output/processed/input_crude_model_ch.rds")
dfc <- readRDS("output/processed/input_crude_model_c.rds")
dfh <- readRDS("output/processed/input_crude_model_h.rds")
...
Antibiotic$type = case_when(
  ...
  Antibiotic$type == "ab_type_num2-2" ~ "Antibiotic type: 2-3",
