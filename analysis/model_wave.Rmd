...
## adjusted model-approximately
```{r}
 
mod4=clogit(case ~ level + CCI + covrx_ever + bmi_cat + care_home + flu_vaccine + smoking_cat_3 + imd+ ethnicity_6 + strata(subclass), df, method="approximate")
summary(mod4)
...
mod4=clogit(case ~ level + CCI + covrx_ever + bmi_cat + care_home + flu_vaccine + smoking_cat_3 + imd+ ethnicity_6 + strata(subclass), df, method="exact")
summary(mod4)
...
mod4=clogit(case ~ level + CCI + covrx_ever + bmi_cat + care_home + flu_vaccine + smoking_cat_3 + imd+ ethnicity_6 + strata(subclass), df, method= "efron")
summary(mod4)
...
mod4=clogit(case ~ level + CCI + covrx_ever + bmi_cat + care_home + flu_vaccine + smoking_cat_3 + imd+ ethnicity_6 + strata(subclass), df, method= "breslow")
summary(mod4)
...
scale_x_continuous(breaks=seq(1.0,3.4,0.3))+
  #xlim(0, 4)+
theme(text=element_text(size=14, color="black"),
      plot.subtitle =element_text(size=12,hjust=0.05),
      panel.spacing = unit(1, "lines"),
