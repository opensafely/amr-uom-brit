...
df <- read_csv(here::here("output", "input_sepsis_2021.csv"),
                col_types = col_spec)
...
write_csv(t, here::here("output", "table_sepsis_2021_0.csv"))
...
write_csv(t1, here::here("output", "table_sepsis_2021_1.csv"))
