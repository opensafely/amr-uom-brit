...
write_csv(result, here::here("output", "cc_model_mortality_1.csv"))
...
write_csv(result, here::here("output", "cc_model_mortality_2.csv"))
...
setDT(result, keep.rownames = TRUE)
write_csv(result, here::here("output", "cc_model_mortality_3.csv"))