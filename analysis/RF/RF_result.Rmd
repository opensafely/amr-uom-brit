...
temp=temp%>%select(decile, explanatory)

data=gather(temp, key =explanatory, value=value, 2:5)


ggplot(data=data, aes(x=decile, y=value, group=explanatory,colour=explanatory)) +
  geom_line()+
