...
ggplot(data=data, aes(x=decile, y=value, group=ab,colour=ab)) +
  geom_line(aes(linetype=ab))+
  geom_point(aes(shape=ab))+
  scale_y_continuous(labels = scales::percent)+
  xlab("")+
  ylab("")+
  theme_bw()+
   scale_shape_manual(values = c(rep(1:10))) +
  scale_color_manual(values = c("coral2","darkred","goldenrod2","forestgreen","dodgerblue","black","darkcyan","cadetblue3","darkochid3"))+
