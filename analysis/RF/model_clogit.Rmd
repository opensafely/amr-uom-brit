...
```{r }
model=clogit(case ~total_ab_group + strata(subclass),df1) 
summary(model)
...
```{r }
model=clogit(case ~ab_types_group + strata(subclass),df1) 
...
```{r }
model=clogit(case ~exposure_period_group + strata(subclass),df1) 
...
```{r }
model=clogit(case ~recent_ab_days_group  + strata(subclass),df1) 
...
```{r }
model=clogit(case ~broad_prop_group  + strata(subclass),df1) 
...
```{r }
model=clogit(case ~broad_ab_prescriptions_group  + strata(subclass),df1) 
...
```{r }
model=clogit(case ~interval_mean_group  + strata(subclass),df1) 
...
```{r }
model=clogit(case ~interval_med_group  + strata(subclass),df1) 
...
```{r }
model=clogit(case ~ interval_CV_group + strata(subclass),df1) 
...
```{r }
model=clogit(case ~ interval_sd_group + strata(subclass),df1) 
...
```{r }
model=clogit(case ~length_mean_group + strata(subclass),df1) 
...
```{r }
model=clogit(case ~length_med_group +  strata(subclass),df1) 
...
```{r }
model=clogit(case ~ length_CV_group+  strata(subclass),df1) 
...
```{r }
model=clogit(case ~ length_sd_group+  strata(subclass),df1) 
