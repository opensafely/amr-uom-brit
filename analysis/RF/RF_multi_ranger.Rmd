...
saveRDS(train_X,here::here("output","development_ranger_1control.rds"))
...
n=as.numeric(table(train_X$case)[2]*0.5)
n

train_X_sub=train_X%>% group_by(case) %>% sample_n(n)
train_X_sub=train_X_sub%>% ungroup(case)
...
saveRDS(rf.model,here::here("output","RF_model_ranger.rds"))
```
...
```{r}
saveRDS(development,here::here("output","development_ranger.rds"))
saveRDS(validation,here::here("output","validation_ranger.rds"))
