...
saveRDS(rf.model,here::here("output","RF_model_ranger_ratio1.rds"))
```
...
```{r}
saveRDS(development,here::here("output","development_ranger_ratio1.rds"))
saveRDS(validation,here::here("output","validation_ranger_ratio1.rds"))
