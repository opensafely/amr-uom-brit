...
```{r }
train <- read_rds(here::here("output","train_cat_2.rds"))
train$case=as.factor(train$case)
valid <- read_rds(here::here("output","valid_cat_2.rds"))
...
saveRDS(rf.model,here::here("output","RF_model_2.rds"))
```
...
```{r}
saveRDS(development,here::here("output","development_2.rds"))
saveRDS(validation,here::here("output","validation_2.rds"))
