...
rf.model=readRDS(here::here("output","RF_model_hosp.rds"))
print(rf.model)
```
...
train$prob <- predict(rf.model,train, type = 'prob')[,2]# votes of being case
...
valid$prob <- predict(rf.model,valid,type = 'prob')[,2]# votes of being case
