...
col=c("case","subclass","total_ab_group","ab_types_group",
...
# random select subclass (1:1 matched)
```{r}
nrow(train)
...
saveRDS(rf.model,here::here("output","RF_model_ranger_1.rds"))
```
...
```{r}
saveRDS(development,here::here("output","development_ranger_1.rds"))
saveRDS(validation,here::here("output","validation_ranger_1.rds"))
