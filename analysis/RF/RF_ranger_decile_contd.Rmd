...
N4=quantile(data$recent_ab_days,0.9)
N5=quantile(data$broad_ab_prescriptions,0.9)
N6=quantile(data$interval_mean,0.9)
N7=quantile(data$interval_sd,0.9)
...
```{r}
names(data)
saveRDS(data,here::here("output","all_ranger_contd.rds"))
```
