...
ggsave(
   plot= plot1,
   filename="variableimp1.png", path=here::here("output"), dpi = 300,
)
...
ggsave(
   plot= plot2,
   filename="variableimp2.png", path=here::here("output"), dpi = 300,
)
```
...
tbl=cbind(exp,obs)# expected value vs. observed value
 write.csv(tbl,here::here("output","RFprop.csv"))
