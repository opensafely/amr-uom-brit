...
data<- read_rds(here::here("output","development_ranger_hosp.rds"))
data$case=as.factor(data$case)

#valid_X <- read_rds("/Users/yayang/Documents/GitHub/amr-uom-brit/output/valid_X.rds")
valid <- read_rds(here::here("output","validation_ranger_hosp.rds"))
...
rf.model=readRDS(here::here("output","RF_model_ranger_hosp.rds"))
print(rf.model)
```
...
```{r}
saveRDS(data,here::here("output","all_ranger_hosp.rds"))
```
