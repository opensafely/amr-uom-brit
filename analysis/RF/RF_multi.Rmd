...
rf.model<- randomForest(formula = case ~ total_ab_group+ab_types_group+exposure_period_group+recent_ab_days_group+broad_ab_prescriptions_group+interval_mean_group+interval_sd_group, 
                          data = train_X, 
                           replace = TRUE,
