...
data_output <- data %>% dplyr::select(EVENT,TEVENT,age,sex,region,imd,ethnicity,bmi,smoking_status_comb,charlsonGrp,ab_3yr,ab_30d,has_uti,has_urti,has_lrti,has_sinusitis,has_ot_externa,has_otmedia,covid)

library(dplyr)

# Specify the columns of interest
columns_of_interest <- c("EVENT", "TEVENT", "age", "sex", "region", "imd", "ethnicity", "bmi", "smoking_status_comb", "charlsonGrp", "ab_3yr", "ab_30d","covid")
...
# Save to CSV
write_csv(missing_data_count, here::here("output", "missing_data_count_all.csv"))


saveRDS(data_output, here::here("output", "data_for_cox_model_all.rds"))
