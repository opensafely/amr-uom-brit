################################################################################
# Part 1: URTI model development process                                        #
################################################################################
...
ggsave(plot_part6, dpi = 700,
       filename = "spline_age_urti_all.jpeg", path = here::here("output"))
...
jpeg(here::here("output", "urti_KM_Curves_all.jpeg"))
...
write_csv(pm, here::here("output", "urti_model_evaluation_all.csv"))
...
jpeg(here::here("output", "urti_High_Low_Risk_Patients_all.jpeg"))
...
jpeg(here::here("output", "urti_survival_plot_baseline_survival_curves_all.jpeg"))
...
jpeg(here::here("output", "urti_survival_plot_baseline_survival_curves2_all.jpeg"))
...
write_csv(results, here::here("output", "urti_model_HR_all.csv"))
...
write_csv(results, here::here("output", "urti_sex_age_band_HR_all.csv"))
...
write_csv(results, here::here("output", "urti_sex_age_spline_HR_all.csv"))
...
write_csv(all_results, here::here("output", "urti_sex_age_var_HR_all.csv"))
...
write_csv(results, here::here("output", "urti_sex_age_band_full_HR_all.csv"))
...
write_csv(pm_ext, here::here("output", "urti_model_external_all.csv"))
...
jpeg(here::here("output", "urti_30day_calibration_all.jpeg"))
...
jpeg(here::here("output", "urti_30day_re-calibration_all.jpeg"))
