...
write_csv(results, here::here("output", "uti_sex_age_band_HR_all.csv"))
...
write_csv(results, here::here("output", "uti_sex_age_spline_HR_all.csv"))
...
write_csv(all_results, here::here("output", "uti_sex_age_var_HR_all.csv"))
...
write_csv(results, here::here("output", "uti_sex_age_band_full_HR_all.csv"))
