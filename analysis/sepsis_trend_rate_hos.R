### This script calculate the rate of Community-acquired sepsis per 1000 person per IMD ###
...
ggsave(figure_imd_strata, width = 10, height = 6, dpi = 640,
       filename="figure_rate_hos.jpeg", path=here::here("output"),
)  

write_csv(df.plot, here::here("output", "figure_rate_hos_table.csv"))