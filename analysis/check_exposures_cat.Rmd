...
# wave
```{r}
ggplot(df, aes(x=wave,fill=case,color=case)) +
  geom_bar(aes(y = ..prop..))+
...
# sex
```{r}
ggplot(df, aes(x=sex, fill=case, color=case)) +
  geom_bar(aes(y = ..prop..))+
  geom_density(alpha=0.5)+
    facet_grid(case~.)
...
#age_cat
```{r}
ggplot(df, aes(x=age_cat,fill=case,color=case)) +
  geom_bar(aes(y = ..prop..))+
    geom_density(alpha=0.5)+
  facet_grid(case~.)
...
#stp
```{r}
ggplot(df, aes(x=stp,fill=case,color=case)) +
  geom_bar(aes(y = ..prop..))+
    geom_density(alpha=0.5)+
  facet_grid(case~.)
...
# region
```{r}
ggplot(df, aes(x=region,fill=case,color=case)) +
  geom_bar(aes(y = ..prop..))+
    geom_density(alpha=0.5)+
  facet_grid(case~.)
...
# ethnicity_6
```{r}
ggplot(df, aes(x=ethnicity_6,fill=case,color=case)) +
  geom_bar(aes(y = ..prop..))+
    geom_density(alpha=0.5)+
  facet_grid(case~.)
...
# bmi_cat
```{r}
ggplot(df, aes(x=bmi_cat,fill=case,color=case)) +
  geom_bar(aes(y = ..prop..))+
    geom_density(alpha=0.5)+
  facet_grid(case~.)
...
# CCI
```{r}
ggplot(df, aes(x=CCI,fill=case,color=case)) +
  geom_bar(aes(y = ..prop..))+
    geom_density(alpha=0.5)+
  facet_grid(case~.)
...
# smoking_cat_3
```{r}
ggplot(df, aes(x=smoking_cat_3,fill=case,color=case)) +
  geom_bar(aes(y = ..prop..))+
    geom_density(alpha=0.5)+
  facet_grid(case~.)
...
# care_home
```{r}
ggplot(df, aes(x=care_home,fill=case,color=case)) +
  geom_bar(aes(y = ..prop..))+
    geom_density(alpha=0.5)+
  facet_grid(case~.)
...
# covrx_ever
```{r}
ggplot(df, aes(x=covrx_ever,fill=case,color=case)) +
  geom_bar(aes(y = ..prop..))+
    geom_density(alpha=0.5)+
  facet_grid(case~.)
...
# flu_vaccine
```{r}
ggplot(df, aes(x=flu_vaccine,fill=case,color=case)) +
  geom_bar(aes(y = ..prop..))+
    geom_density(alpha=0.5)+
  facet_grid(case~.)
...
# ab_qn
```{r}
ggplot(df, aes(x=ab_qn,fill=case,color=case)) +
  geom_bar(aes(y = ..prop..))+
    geom_density(alpha=0.5)+
  facet_grid(case~.)
...
# br_ab_qn
```{r}
ggplot(df, aes(x=br_ab_qn,fill=case,color=case)) +
  geom_bar(aes(y = ..prop..))+
    geom_density(alpha=0.5)+
  facet_grid(case~.)
