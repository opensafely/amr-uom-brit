...
write_csv(df.model, here::here("output", "sen_3mon_all_coded.csv"))
...
write_csv(df.model, here::here("output", "sen_3mon_all_uncoded.csv"))
rm(df,df.all,df.broad,df.broad_total,df.model)
...
write_csv(df.model, here::here("output", "sen_3mon_uti.csv"))
rm(df,df.all,df.broad,df.broad_total,df.model)
...
write_csv(df.model, here::here("output", "sen_3mon_cold.csv"))
rm(df,df.all,df.broad,df.broad_total,df.model)
...
write_csv(df.model, here::here("output", "sen_3mon_cough.csv"))
rm(df,df.all,df.broad,df.broad_total,df.model)
...
write_csv(df.model, here::here("output", "sen_3mon_copd.csv"))
rm(df,df.all,df.broad,df.broad_total,df.model)
...
write_csv(df.model, here::here("output", "sen_3mon_throat.csv"))
rm(df,df.all,df.broad,df.broad_total,df.model)
...
write_csv(df.model, here::here("output", "sen_3mon_lrti.csv"))
rm(df,df.all,df.broad,df.broad_total,df.model)
...
write_csv(df.model, here::here("output", "sen_3mon_urti.csv"))
rm(df,df.all,df.broad,df.broad_total,df.model)
...
write_csv(df.model, here::here("output", "sen_3mon_sinusitis.csv"))
rm(df,df.all,df.broad,df.broad_total,df.model)
...
write_csv(df.model, here::here("output", "sen_3mon_ot_media.csv"))
rm(df,df.all,df.broad,df.broad_total,df.model)
...
write_csv(df.model, here::here("output", "sen_3mon_ot_externa.csv"))
rm(df,df.all,df.broad,df.broad_total,df.model)
rm(DF)
...
write_csv(df.model, here::here("output", "sen_3mon_all.csv"))
