...
df=df%>%mutate(ab_qn_type= 
                 case_when(total_ab_qn_5==0 & abtype_3==0 ~ "0",
                           ...
                           total_ab_qn_5==1 & abtype_3==2 ~ "2",
                           total_ab_qn_5==1 & abtype_3>=3 ~ "3",
                           total_ab_qn_5==2 & abtype_3<=2 ~ "4",
                           total_ab_qn_5==2 & abtype_3==3 ~ "5",
                           total_ab_qn_5==2 & abtype_3>=4 ~ "6",
                           total_ab_qn_5==3 & abtype_3<=2 ~ "7",
                           total_ab_qn_5==3 & abtype_3>=3 ~ "8",
                           total_ab_qn_5==4 & abtype_3<=2 ~ "9",
                           total_ab_qn_5==4 & abtype_3>=3 ~ "10"
                          ))
...
DF$AB_exposure=factor(DF$AB_exposure,levels=c("ab_qn_type1","ab_qn_type2","ab_qn_type3","ab_qn_type4","ab_qn_type5","ab_qn_type6","ab_qn_type7","ab_qn_type8","ab_qn_type9","ab_qn_type10"))
