...
df1=df1%>% select("patient_id","patient_index_date","had_antibiotic","age","sex","stp","cal_YM")
colnames(df1)=c("patient_id","patient_index_date","total_ab","age","sex","stp","cal_YM")
nrow(df1)
```
...
df0=df0%>%select("patient_id","index_date","total_ab","age","sex","stp","cal_YM")
colnames(df0)=c("patient_id","patient_index_date","total_ab","age","sex","stp","cal_YM")
