...
```{r}
# impoprt data
df1 <- read_csv(here::here("output", "input_covid_SGSS_2.csv"))
nrow(df1)
...
## primary care
```{r}
df2<- read_csv(here::here("output", "input_covid_primarycare_2.csv"))
nrow(df2)
...
df.1 <- read_csv(here::here("output", "input_covid_admission_2.csv"))
nrow(df.1)
...
write_csv(df.1, here::here("output", "case_covid_hosp_2.csv"))
```
