...
df1=df1%>%select("sex","age","age_cat","region","case") 
...
df2=df2%>%select("sex","age","age_cat","region","case") 
...
explanatory<- c("sex","age","age_cat","region")
dependent <- "matched"
...
# redacted
#ound_tbl[,3]=ifelse(round_tbl[,3]<7,NA,round_tbl[,3])
