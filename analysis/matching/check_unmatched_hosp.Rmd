...
```{r}
df <- read_rds(here::here("output","matched_patients_hosp.rds"))
...
df1 <- read_rds(here::here("output","matched_patients_hosp.rds"))
df1=df1%>%select( "case","age" ,"sex"  ,"stp" ) 
df1=subset(df1,case==1)
df1$matched="1"

df2 <- read_rds(here::here("output","unmatched_cases_hosp.rds"))
