...
#xlim(c(0,2.2))+
scale_x_continuous(limits = c(0.6,6.5),breaks = c(1.0,1.5,2.0,2.5,3,3.5,4,4.5,5,5.5,6,6.5))+
...
geom_errorbarh(aes(xmin=CI_L, xmax=CI_U, height = .2))+
  geom_errorbarh(data=DF2,aes(xmin=CI_L, xmax=CI_U, height = .2))+
  geom_errorbarh(data=DF3,aes(xmin=CI_L, xmax=CI_U, height = .2))+
  geom_errorbarh(data=DF4,aes(xmin=CI_L, xmax=CI_U, height = .2))+
