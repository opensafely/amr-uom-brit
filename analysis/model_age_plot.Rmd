...
mod1=clogit(case ~ ab_qn_type +  CCI +  covrx_ever + bmi_cat + care_home + flu_vaccine + smoking_cat_3 + imd+ ethnicity_6 + strata(subclass), df1)
...
geom_point(data=DF3, color="green")+
geom_point(data=DF2, color="grey")+  
  
  
  # lenend
  
   scale_color_manual(name='Age groups',
                     breaks=c('18-39', '40-59', '60-79','80+'),
                     values=c('18-39'='blue', '40-59'='red', '60-79'='green','80+'='grey'))+
