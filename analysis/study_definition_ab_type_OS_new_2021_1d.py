...
##### indication fit on AB date 1-12
    ...
    AB_date_1_indication=patients.with_these_clinical_events(
        ...
        find_first_match_in_period = True,
        returning="category",      
        between=["AB_1_date", "AB_1_date + 1 day"],
        return_expectations={
