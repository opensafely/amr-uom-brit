...
df=df%>% select( "patient_id" , "patient_index_date","case","subclass",
             ...
             "AB_6wk" ,"total_ab","ab_types",
             "exposure_period"  ,
               "recent_ab_days",  
              "broad_prop" ,"broad_ab_prescriptions",
               "interval_mean" ,"interval_CV",
             
               )
#"ab_prescriptions", "prescribe_times","length_med" "interval_med"  "length_mean", "length_sd" ,  "length_CV"  "interval_sd" , 
...
```{r}
var= df[,8:16]
cor(var, use = "pairwise.complete.obs")
