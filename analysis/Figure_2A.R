...
ggsave(Figure1, width = 14, height = 8,dpi = 700,
       filename="Figure_2A_adjusted_1.jpeg", path=here::here("output"),
)  

p1 <- forest(dt[c(16:28),c(1,12:15)],  
            est = list(dt$OR[16:28],
                       dt$OR2[16:28],
                       dt$OR3[16:28]),
            lower =list(dt$CI_L[16:28], 
                        dt$CI_L2[16:28],
                        dt$CI_L3[16:28]),
            upper =list(dt$CI_U[16:28],
                        dt$CI_U2[16:28],
                        dt$CI_U3[16:28]),
            ci_column = 2,
            ref_line = 1,
...
ggsave(Figure1, width = 14, height = 6,dpi = 700,
       filename="Figure_2A_adjusted_2.jpeg", path=here::here("output"),
)  