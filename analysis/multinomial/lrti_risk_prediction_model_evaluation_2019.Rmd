---
title: "lrti_risk_prediction_model_evaluation"
author: "Billy"
date: "17/05/2022"
...
```{r}
DF <- read_csv(here("output","lrti_outcome_2019.csv"))
DF <- DF %>% filter (age>3)
...
k=3
p <- predict(m1 , newdata = testing,type="probs")
LP21 <- as.matrix(log(p[,2]/p[,1]))
LP31 <- as.matrix(log(p[,3]/p[,1]))
LP <- cbind(LP21,LP31)
r=1
estimates=FALSE
dfr=2
