...
m1 <- vgam(outcome ~ rcs(age, Knots.manual) + sex + infection+ ethnicity_6 + region + charlsonGrp + imd + ab12b4,  family = multinomial(parallel = FALSE, refLevel = 1), data =training)
summaryvglm(m1)
```
