...
df3.1 <- read_csv("prepared_var_extra_2019.csv") %>% select(c(patient_id, bmi_cat, smoking_cat_3, hospital_counts))
df3.2 <- read_csv("prepared_var_extra_2020.csv") %>% select(c(patient_id, bmi_cat, smoking_cat_3, hospital_counts))
df3.3 <- read_csv("prepared_var_extra_2021.csv") %>% select(c(patient_id, bmi_cat, smoking_cat_3, hospital_counts))
