...
m1 <- vgam(outcome ~ age + sex + ethnicity_6 + region + charlsonGrp + imd + ab12b4, family = multinomial(parallel = FALSE, refLevel = 1), data =training)
...
```{r}
quantile(testing$age, probs = c(.05, .275,.5, .725,.95))
```
