...
df_input <- read_csv("input_demographic_2019.csv",
               col_types = cols_only(
...
write_csv(overall_counts, here::here("output", "prepare_var_count_2019.csv"))
rm(overall_counts) 
...
#str(t)
write_csv(t, here::here("output", "blt_var_2019.csv"))