...
model<- rpart(
  case ~ exposure_period_group+age.x, 
  data = data, 
  method = "class",
 control=rpart.control(minsplit=2, minbucket=1, cp=0.001)  )
...
set.seed(324)
model<- rpart(
  case ~ recent_ab_days_group+age.x, 
  data = data, 
  method = "class",
 control=rpart.control(minsplit=2, minbucket=1, cp=0.001)  )
...
set.seed(324)
model<- rpart(
  case ~ broad_ab_prescriptions_group+age.x, 
  data = data, 
  method = "class",
 control=rpart.control(minsplit=2, minbucket=1, cp=0.001)  )
print(model)
