...
```{r }
model=clogit(case ~total_ab_group +ab_types_group+exposure_period_group+recent_ab_days_group+broad_ab_prescriptions_group+interval_med_group++strata(subclass),df) 
summary(model)
