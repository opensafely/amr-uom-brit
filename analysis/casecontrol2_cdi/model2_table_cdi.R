...
for (ds in datasets) {
  ...
  data <- readRDS(here::here("output", "processed", paste0("model_", ds, "_cdi.rds")))
  ...
  write_csv(case_summary, here::here("output", paste0("table_2_", ds, "_case_cdi.csv")))
  ...
  write_csv(control_summary, here::here("output", paste0("table_2_", ds, "_control_cdi.csv")))
