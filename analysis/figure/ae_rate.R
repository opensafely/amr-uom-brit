...
df$admitted_rate <- round((df$admitted*1000/df$population), 3)
df$ae_admitted_rate <- round((df$ae_admitted*1000/df$population), 3)
df$uti_ae_rate <- round((df$uti_ae*1000/df$population), 3)
df$lrti_ae_rate <- round((df$lrti_ae*1000/df$population), 3)
df$urti_ae_rate <- round((df$urti_ae*1000/df$population), 3)
df$sinusitis_ae_rate <- round((df$sinusitis_ae*1000/df$population), 3)
df$ot_externa_ae_rate <- round((df$ot_externa_ae*1000/df$population), 3)
df$ot_media_ae_rate <- round((df$ot_media_ae*1000/df$population), 3)
df$pneumonia_ae_rate <- round((df$pneumonia_ae*1000/df$population), 3)
