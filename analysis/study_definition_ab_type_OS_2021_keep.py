...
##### indication fit on AB date 1-12
    ...
    AB_date_2_indication_binary=patients.with_these_clinical_events(
        antibiotics_indications,
        between=["AB_2_date", "AB_2_date"],
        returning="binary_flag",
        return_expectations={"incidence": 0.8},
    ...
    AB_date_3_indication_binary=patients.with_these_clinical_events(
        antibiotics_indications,
        between=["AB_3_date", "AB_3_date"],
        returning="binary_flag",
        return_expectations={"incidence": 0.8},
    ...
    AB_date_4_indication_binary=patients.with_these_clinical_events(
        antibiotics_indications,
        between=["AB_4_date", "AB_4_date"],
        returning="binary_flag",
        return_expectations={"incidence": 0.8},
