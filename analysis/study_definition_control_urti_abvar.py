...
COHORT = "output/matched_matches_urti.csv"
...
from variables_antibiotics_control import generate_ab_control_variables
from variables_CCI import generate_CCI_variables
ab_control_variables = generate_ab_control_variables(index_date_variable="patient_index_date")
