...
main <- function(condition) {
  ...
  write_csv(medication_freq_pivot, here::here("output", paste0(condition,"_ab_medication_freq_renal.csv")))
  ...
  write_csv(combined_df, here::here("output", paste0(condition,"_ab_type_OR_renal.csv")))
}
