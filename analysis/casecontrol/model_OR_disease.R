...
main <- function(condition) {
 ...
 # Create a frequency table
  ...
  write_csv(as.data.frame(freq_table), here::here("output", paste0(condition, "_freq_disease.csv")))
  ...
  write_csv(combined_df, here::here("output", paste0(condition, "_model_result_disease.csv")))
}
