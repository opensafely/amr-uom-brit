...
main <- function(condition) {
  ...
  write_csv(medication_freq_pivot, here::here("output", paste0(condition,"_ab_medication_freq_disease.csv")))
  ...
  write_csv(combined_df, here::here("output", paste0(condition,"_ab_type_OR_disease.csv")))
}
