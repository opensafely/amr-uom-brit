...
df <- df %>% filter(side_effect == "1")
  ...
  write_csv(medication_freq_pivot, here::here("output", paste0(condition,"_ab_history_freq_sideeffect.csv")))
  ...
  write_csv(combined_df, here::here("output", paste0(condition, "_abhistory_model_result_sideeffect.csv")))
}
