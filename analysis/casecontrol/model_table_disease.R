...
for (ds in datasets) {
  ...
  write_csv(case_summary, here::here("output", paste0("table_1_", ds, "_case_disease.csv")))
  ...
  write_csv(control_summary, here::here("output", paste0("table_1_", ds, "_control_disease.csv")))
