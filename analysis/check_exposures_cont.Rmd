...
table<- df %>% select(case,lastABtime)
tbl_summary(table, by=case)
```
...
table<- df %>% select(case,ab_prescriptions)
tbl_summary(table, by=case)
```
...
table<- df %>% select(case,broad_ab_prescriptions)
tbl_summary(table, by=case)
```
