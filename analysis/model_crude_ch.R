...
+ ethnicity + bmi + smoking_status + hypertension + chronic_respiratory_disease +
             ...
             learning_disability + sev_mental_ill + alcohol_problems + care_home_type_ba + ckd_rrt + strata(set_id),
...
write_csv(DF, here::here("output", "crude_model_result.csv"))

output_dir <- here("output", "processed")
fs::dir_create(output_dir)
saveRDS(object = DF,
        file = paste0(output_dir, "/input_", "crude_model_ch", ".rds"),
        compress = TRUE)