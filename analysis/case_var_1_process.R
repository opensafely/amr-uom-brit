...
input_files <- c("input_case_uti_var_1.csv",
                 "input_case_lrti_var_1.csv",
                 "input_case_urti_var_1.csv",
                 "input_case_sinusitis_var_1.csv",
                 "input_case_ot_externa_var_1.csv",
                 "input_case_ot_media_var_1.csv",
                 "input_case_pneumonia_var_1.csv")
