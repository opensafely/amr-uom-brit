...
# import data
df <- read_csv(here::here("output", "input_covid_admission_2.csv"))
...
write_csv(DF1, here::here("output", "case_covid_icu_death_2.csv"))
write_csv(DF0, here::here("output", "control_covid_hosp_2.csv"))
write_csv(DF_ICU, here::here("output", "case_covid_icu_2.csv"))
