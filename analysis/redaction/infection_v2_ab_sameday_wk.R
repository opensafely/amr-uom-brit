...
df=readRDS("abtype_sinusitis_wk.rds")
df=bind_rows(df)
...
df=readRDS("abtype_ot_externa_wk.rds")
df=bind_rows(df)
...
df=readRDS("abtype_otmedia_wk.rds")
df=bind_rows(df)
