...
write_csv(df, here::here("output","redacted" ,"count_abtype_uti_check.csv"))
...
write_csv(df, here::here("output","redacted","count_abtype_uti.csv"))
...
## # line graph-rate
# prevalent
lineplot.1<- ggplot(df.plot.1, aes(x=date, y=counts,group=type,color=type))+
...
# incident
lineplot.0<- ggplot(df.plot.0, aes(x=date,y=counts,group=type,color=type))+
  annotate(geom = "rect", xmin = as.Date("2021-01-01"),xmax = as.Date("2021-04-01"),ymin = -Inf, ymax = Inf,fill="grey80", alpha=0.5)+
  annotate(geom = "rect", xmin = as.Date("2020-11-01"),xmax = as.Date("2020-12-01"),ymin = -Inf, ymax = Inf,fill="grey80", alpha=0.5)+
  annotate(geom = "rect", xmin = as.Date("2020-03-01"),xmax = as.Date("2020-06-01"),ymin = -Inf, ymax = Inf,fill="grey80", alpha=0.5)+
  geom_line(aes(linetype=type))+
...
ggsave(
  plot= lineplot,
  filename="count_abtype_uti.jpeg", path=here::here("output","redacted")) 
...
df.plot.0$prevalent=as.factor(0)
df=rbind(df.plot.1,df.plot.0)
write_csv(df, here::here("output","redacted","count_abtype_lrti_check.csv"))
...
write_csv(df, here::here("output","redacted","count_abtype_lrti.csv"))
...
ggsave(
  plot= lineplot,
  filename="count_abtype_lrti.jpeg", path=here::here("output","redacted")) 
...
df.plot.0$prevalent=as.factor(0)
df=rbind(df.plot.1,df.plot.0)
write_csv(df, here::here("output","redacted","count_abtype_urti_check.csv"))
...
write_csv(df, here::here("output","redacted","count_abtype_urti.csv"))
...
ggsave(
  plot= lineplot,
  filename="count_abtype_urti.jpeg", path=here::here("output","redacted")) 
...
df.plot.0$prevalent=as.factor(0)
df=rbind(df.plot.1,df.plot.0)
write_csv(df, here::here("output","redacted","count_abtype_sinusitis_check.csv"))
...
write_csv(df, here::here("output","redacted","count_abtype_sinusitis.csv"))
...
ggsave(
  plot= lineplot,
  filename="count_abtype_sinusitis.jpeg", path=here::here("output","redacted")) 
...
df.plot.0$prevalent=as.factor(0)
df=rbind(df.plot.1,df.plot.0)
write_csv(df, here::here("output","redacted","count_abtype_ot_externa_check.csv"))
...
write_csv(df, here::here("output","redacted","count_abtype_ot_externa.csv"))
...
ggsave(
  plot= lineplot,
  filename="count_abtype_ot_externa.jpeg", path=here::here("output","redacted")) 
...
df.plot.0$prevalent=as.factor(0)
df=rbind(df.plot.1,df.plot.0)
write_csv(df, here::here("output","redacted","count_abtype_otmedia_check.csv"))
...
write_csv(df, here::here("output","redacted", "count_abtype_otmedia.csv"))
...
ggsave(
  plot= lineplot,
  filename="count_abtype_otmedia.jpeg", path=here::here("output","redacted")) 
