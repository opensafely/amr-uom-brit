...
# file list
csvFiles_20_2 = c("input_ab_predictor_2020_2020-07-01.csv.gz","input_ab_predictor_2020_2020-08-01.csv.gz",
...
# date list
date_20= seq(as.Date("2020-07-01"), as.Date("2020-12-01"), "month")
...
saveRDS(temp2, "process_2_20_part_2.rds")
rm(temp2)