...
# file list
csvFiles_21_2 = c("input_ab_predictor_2021_2021-01-01.csv.gz","input_ab_predictor_2021_2021-02-01.csv.gz",
                  "input_ab_predictor_2021_2021-03-01.csv.gz","input_ab_predictor_2021_2021-04-01.csv.gz",
                  "input_ab_predictor_2021_2021-05-01.csv.gz","input_ab_predictor_2021_2021-06-01.csv.gz",
                  "input_ab_predictor_2021_2021-07-01.csv.gz","input_ab_predictor_2021_2021-08-01.csv.gz",
                  "input_ab_predictor_2021_2021-09-01.csv.gz","input_ab_predictor_2021_2021-10-01.csv.gz",
                  "input_ab_predictor_2021_2021-11-01.csv.gz","input_ab_predictor_2021_2021-12-01.csv.gz")
...
temp2 <- vector("list", length(csvFiles_21_2))
for (i in seq_along(csvFiles_21_2)){
  # read in one-month data
  df <- read_csv((csvFiles_21_2[i]),
                 col_types = cols_only(
...
saveRDS(temp2, "process_2_2021.rds")
rm(temp2)