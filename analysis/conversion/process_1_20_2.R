...
# file list
csvFiles_20 = c("input_ab_type_2020_2020-07-01.csv.gz","input_ab_type_2020_2020-08-01.csv.gz","input_ab_type_2020_2020-09-01.csv.gz",
...
saveRDS(temp, "process_1_20_part_2.rds")
rm(temp)
