...
# file list
csvFiles_21 = c("input_ab_type_2021_2021-07-01.csv.gz","input_ab_type_2021_2021-08-01.csv.gz","input_ab_type_2021_2021-09-01.csv.gz",
...
saveRDS(temp, "process_1_21_part_2.rds")
rm(temp)
