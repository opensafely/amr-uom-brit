...
# file list
csvFiles_21_2 = c("input_ab_predictor_2021_2021-07-01.csv.gz","input_ab_predictor_2021_2021-08-01.csv.gz",
...
# date list
date_21= seq(as.Date("2021-07-01"), as.Date("2021-12-01"), "month")
...
saveRDS(temp2, "process_2_21_part_2.rds")
rm(temp2)