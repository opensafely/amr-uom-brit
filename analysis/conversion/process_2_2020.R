...
# file list
csvFiles_20_2 = c("input_ab_predictor_2020_2020-01-01.csv.gz","input_ab_predictor_2020_2020-02-01.csv.gz",
                  "input_ab_predictor_2020_2020-03-01.csv.gz","input_ab_predictor_2020_2020-04-01.csv.gz",
                  "input_ab_predictor_2020_2020-05-01.csv.gz","input_ab_predictor_2020_2020-06-01.csv.gz",
                  "input_ab_predictor_2020_2020-07-01.csv.gz","input_ab_predictor_2020_2020-08-01.csv.gz",
                  "input_ab_predictor_2020_2020-09-01.csv.gz","input_ab_predictor_2020_2020-10-01.csv.gz",
                  "input_ab_predictor_2020_2020-11-01.csv.gz","input_ab_predictor_2020_2020-12-01.csv.gz")
...
temp2 <- vector("list", length(csvFiles_20_2))
for (i in seq_along(csvFiles_20_2)){
  # read in one-month data
  df <- read_csv((csvFiles_20_2[i]),
                 col_types = cols_only(
...
saveRDS(temp2, "process_2_2020.rds")
rm(temp2)