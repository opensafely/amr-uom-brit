...
# file list
csvFiles = c("input_ab_type_2019_2019-01-01.csv.gz","input_ab_type_2019_2019-02-01.csv.gz","input_ab_type_2019_2019-03-01.csv.gz",
                "input_ab_type_2019_2019-04-01.csv.gz","input_ab_type_2019_2019-05-01.csv.gz","input_ab_type_2019_2019-06-01.csv.gz",
                "input_ab_type_2019_2019-07-01.csv.gz","input_ab_type_2019_2019-08-01.csv.gz","input_ab_type_2019_2019-09-01.csv.gz",
                "input_ab_type_2019_2019-10-01.csv.gz","input_ab_type_2019_2019-11-01.csv.gz","input_ab_type_2019_2019-12-01.csv.gz")
...
saveRDS(DF_ab, "process_1_2019.rds")