...
# file list
csvFiles_19 = c("input_ab_type_2019_2019-07-01.csv.gz","input_ab_type_2019_2019-08-01.csv.gz","input_ab_type_2019_2019-09-01.csv.gz",
...
saveRDS(temp, "process_1_19_part_2.rds")
rm(temp)
