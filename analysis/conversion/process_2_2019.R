...
# file list
csvFiles_19_2 = c("input_ab_predictor_2019_2019-01-01.csv.gz","input_ab_predictor_2019_2019-02-01.csv.gz",
                  "input_ab_predictor_2019_2019-03-01.csv.gz","input_ab_predictor_2019_2019-04-01.csv.gz",
                  "input_ab_predictor_2019_2019-05-01.csv.gz","input_ab_predictor_2019_2019-06-01.csv.gz",
                  "input_ab_predictor_2019_2019-07-01.csv.gz","input_ab_predictor_2019_2019-08-01.csv.gz",
...
saveRDS(temp2, "process_2_2019.rds")
rm(temp2)