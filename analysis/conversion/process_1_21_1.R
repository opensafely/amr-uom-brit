...
# file list
csvFiles_21 = c("input_ab_type_2021_2021-01-01.csv.gz","input_ab_type_2021_2021-02-01.csv.gz","input_ab_type_2021_2021-03-01.csv.gz",
...
saveRDS(temp, "process_1_21_part_1.rds")
rm(temp)
