...
# file list
csvFiles_20 = c("input_ab_type_2020_2020-01-01.csv.gz","input_ab_type_2020_2020-02-01.csv.gz","input_ab_type_2020_2020-03-01.csv.gz",
...
saveRDS(temp, "process_1_20_part_1.rds")
rm(temp)
