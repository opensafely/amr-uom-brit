...
write_csv(plotimd, here::here("output", "cc_adjusted_plotimd.csv"))
write_csv(plota, here::here("output", "cc_adjusted_plota.csv"))
write_csv(plotb, here::here("output", "cc_adjusted_plotb.csv"))
write_csv(plotc, here::here("output", "cc_adjusted_plotc.csv"))
write_csv(plotd, here::here("output", "cc_adjusted_plotd.csv"))
write_csv(plote, here::here("output", "cc_adjusted_plote.csv"))