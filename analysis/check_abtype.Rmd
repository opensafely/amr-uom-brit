...
ggplot(df, aes(y=Rx_Nitrofurantoin,x=case)) + 
    geom_boxplot() 


df$case=as.factor(df$case)
ggplot(df, aes(y=Rx_Trimethoprim,x=case)) + 
    geom_boxplot() 


df$case=as.factor(df$case)
ggplot(df, aes(y=Rx_Amoxicillin,x=case)) + 
    geom_boxplot() 

df$case=as.factor(df$case)
ggplot(df, aes(y= Rx_Flucloxacillin, x=case)) + 
    geom_boxplot() 

df$case=as.factor(df$case)
ggplot(df, aes(y=Rx_Doxycycline,x=case)) + 
    geom_boxplot() 
