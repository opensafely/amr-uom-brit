...
ggplot(DF, aes(Rx_Amoxicillin,Rx_Doxycycline)) +
  geom_point(aes(color=case),alpha = 1/10) +
  geom_line(aes(group = subclass),alpha = 1/10)

ggplot(DF, aes(Rx_Amoxicillin,Rx_Flucloxacillin)) +
  geom_point(aes(color=case),alpha = 1/10) +
  geom_line(aes(group = subclass),alpha = 1/10)

ggplot(DF, aes(Rx_Nitrofurantoin,Rx_Trimethoprim)) +
  geom_point(aes(color=case),alpha = 1/10) +
  geom_line(aes(group = subclass),alpha = 1/10)
```
