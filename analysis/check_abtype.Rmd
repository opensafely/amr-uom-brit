...
```{r}
sub.df=subset(df, diff_N >0)
barplot(sub.df$diff_N)

sub.df=subset(df, diff_T >0)
barplot(sub.df$diff_T)

sub.df=subset(df, diff_A >0)
barplot(sub.df$diff_A)

sub.df=subset(df, diff_F >0)
barplot(sub.df$diff_F)

sub.df=subset(df, diff_D >0)
barplot(sub.df$diff_D)
