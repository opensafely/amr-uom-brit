...
df$quintile=ifelse(df$total_ab<qn_cat1,1,NA)

df$quintile=ifelse(df$total_ab>qn_cat1 & df$total_ab<qn_cat2,2,df$quintile)
df$quintile=ifelse(df$total_ab>qn_cat2 & df$total_ab<qn_cat3,3,df$quintile)

df$quintile=ifelse(df$total_ab>qn_cat3 & df$total_ab<qn_cat4,4,df$quintile)

df$quintile=ifelse(df$total_ab>qn_cat4 ,5,df$quintile)

table(df$quintile)

summary(df[df$quintile==1,]$total_ab)
summary(df[df$quintile==2,]$total_ab)
summary(df[df$quintile==3,]$total_ab)
summary(df[df$quintile==4,]$total_ab)
summary(df[df$quintile==5,]$total_ab)
