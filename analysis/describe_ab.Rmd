...
df$quintile=ifelse(df$total_ab >qn_cat3 & df$total_ab <=qn_cat4,3,df$level)
df$quintile=ifelse(df$total_ab >qn_cat4,4,df$level)
...
df$quintile=ifelse(df$total_ab==qn_cat3,3,df$level)
df$quintile=ifelse(df$total_ab >qn_cat3 &df$total_ab <=qn_cat4 ,4,df$level)
df$quintile=ifelse(df$total_ab >qn_cat4 ,5,df$level)
