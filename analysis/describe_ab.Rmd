...
ggplot(df, aes(x=br_ab_qn)) +
  geom_bar()+
  facet_grid(ab_qn_5~case)
table(df$ab_qn_5,df$br_ab_qn)
prop.table(table(df$ab_qn_5,df$br_ab_qn),margin=1)*100
...
ggplot(df, aes(x=br_ab_qn)) +
  geom_bar()+
  facet_grid(total_ab_qn~case)
table(df$total_ab_qn,df$br_ab_qn)
prop.table(table(df$total_ab_qn,df$br_ab_qn),margin=1)*100
```
...
ggplot(df, aes(x=br_ab_qn)) +
  geom_bar()+
  facet_grid(total_ab_qn_5~case)
table(df$total_ab_qn_5,df$br_ab_qn)
prop.table(table(df$total_ab_qn_5,df$br_ab_qn),margin=1)*100
...
ggplot(df, aes(x=br_total_ab_qn)) +
  geom_bar()+
  facet_grid(ab_qn~case)
table(df$ab_qn,df$br_total_ab_qn)
prop.table(table(df$ab_qn,df$br_total_ab_qn),margin=1)*100
```
...
ggplot(df, aes(x=br_total_ab_qn)) +
  geom_bar()+
  facet_grid(ab_qn_5~case)
table(df$ab_qn_5,df$br_total_ab_qn)
prop.table(table(df$ab_qn_5,df$br_total_ab_qn),margin=1)*100
...
ggplot(df, aes(x=br_total_ab_qn)) +
  geom_bar()+
  facet_grid(total_ab_qn~case)
table(df$total_ab_qn,df$br_total_ab_qn)
prop.table(table(df$total_ab_qn,df$br_total_ab_qn),margin=1)*100
```
...
ggplot(df, aes(x=br_total_ab_qn)) +
  geom_bar()+
  facet_grid(total_ab_qn_5~case)
table(df$total_ab_qn_5,df$br_total_ab_qn)
prop.table(table(df$total_ab_qn_5,df$br_total_ab_qn),margin=1)*100
