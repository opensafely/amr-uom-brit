...
Files = list.files(pattern="measure_ratio_oc", full.names = FALSE)
temp <- vector("list", length(Files))
...
ggsave(
  plot= lineplot,
  filename="uti_ab_ratio_check_line_oc.jpeg", path=here::here("output"),
)
...
ggsave(
  plot= lineplot2,
  filename="uti_ab_ratio_check_line2_oc.jpeg", path=here::here("output"),
) 
...
ggsave(
  plot= lineplot3,
  filename="uti_ab_ratio_check_line3_oc.jpeg", path=here::here("output"),
) 
write_csv(dat, here::here("output", "uti_ab_ratio_check_oc.csv"))
