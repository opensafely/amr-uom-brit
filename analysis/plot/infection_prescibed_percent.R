...
## 1.1 UTI
df <- read_csv(
  here::here("output", "measures", "measure_Rx_percent_UTI.csv"),
               col_types = cols_only(
...
## 1.2 URTI
df <- read_csv(
  here::here("output", "measures", "measure_Rx_percent_URTI.csv"),
               col_types = cols_only(
...
## 1.3 LRTI
df <- read_csv(
  here::here("output", "measures", "measure_Rx_percent_LRTI.csv"),
               col_types = cols_only(
...
# 1.4 sinusitis
df <- read_csv(
  here::here("output", "measures", "measure_Rx_percent_sinusitis.csv"),
               col_types = cols_only(
...
# 1.5 ot_externa
df <- read_csv(
  here::here("output", "measures", "measure_Rx_percent_ot_externa.csv"),
               col_types = cols_only(
...
# 1.6 otmedia
df <- read_csv(
  here::here("output", "measures", "measure_Rx_percent_otmedia.csv"),
               col_types = cols_only(
