...
ggsave(
  plot= stackedbar,
  filename="LRTI.png", path=here::here("output","plot_consultation"), ### !!  ####
)
...
ggsave(
  plot= stackedbar,
  filename="URTI.png", path=here::here("output","plot_consultation"), ### !!  ####
)
...
ggsave(
  plot= stackedbar,
  filename="sinusitis.png", path=here::here("output","plot_consultation"), ### !!  ####
)
...
ggsave(
  plot= stackedbar,
  filename="ot_externa.png", path=here::here("output","plot_consultation"), ### !!  ####
)
...
ggsave(
  plot= stackedbar,
  filename="otmedia.png", path=here::here("output","plot_consultation"), ### !!  ####
)
