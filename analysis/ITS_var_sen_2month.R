...
covid_adjustment_period_from = as.Date("2020-02-01")
...
write_csv(df.model, here::here("output", "sen_2mon_all_coded.csv"))
...
write_csv(df.model, here::here("output", "sen_2mon_all_uncoded.csv"))
rm(df,df.all,df.broad,df.broad_total,df.model)
...
write_csv(df.model, here::here("output", "sen_2mon_uti.csv"))
rm(df,df.all,df.broad,df.broad_total,df.model)
...
write_csv(df.model, here::here("output", "sen_2mon_cold.csv"))
rm(df,df.all,df.broad,df.broad_total,df.model)
...
write_csv(df.model, here::here("output", "sen_2mon_cough.csv"))
rm(df,df.all,df.broad,df.broad_total,df.model)
...
write_csv(df.model, here::here("output", "sen_2mon_copd.csv"))
rm(df,df.all,df.broad,df.broad_total,df.model)
...
write_csv(df.model, here::here("output", "sen_2mon_throat.csv"))
rm(df,df.all,df.broad,df.broad_total,df.model)
...
write_csv(df.model, here::here("output", "sen_2mon_lrti.csv"))
rm(df,df.all,df.broad,df.broad_total,df.model)
...
write_csv(df.model, here::here("output", "sen_2mon_urti.csv"))
rm(df,df.all,df.broad,df.broad_total,df.model)
...
write_csv(df.model, here::here("output", "sen_2mon_sinusitis.csv"))
rm(df,df.all,df.broad,df.broad_total,df.model)
...
write_csv(df.model, here::here("output", "sen_2mon_ot_media.csv"))
rm(df,df.all,df.broad,df.broad_total,df.model)
...
write_csv(df.model, here::here("output", "sen_2mon_ot_externa.csv"))
rm(df,df.all,df.broad,df.broad_total,df.model)
rm(DF)
...
write_csv(df.model, here::here("output", "sen_2mon_all.csv"))
