...
# This script extracts the antibiotics records by using the antibiotic codelist by OpenS in 2019
...
## all ABs in 2022 using Brit codelist
    ab_OS=patients.with_these_medications(
        antibacterials_codes,
        between=[start_date, end_date],
