...
# adjusted individual disease model
...
# fully-adjussted model

```{r}
 
mod3=clogit(case ~ level + 
              cancer_comor+cerebrovascular_disease_comor+ chronic_obstructive_pulmonary_comor+ heart_failure_comor+ connective_tissue_comor+ dementia_comor+ diabetes_comor+ diabetes_complications_comor+ hemiplegia_comor+ hiv_comor+ metastatic_cancer_comor+ mild_liver_comor+ mod_severe_liver_comor+ mod_severe_renal_comor+ mi_comor+ peptic_ulcer_comor+ peripheral_vascular_comor + covrx_ever + bmi_cat + care_home + flu_vaccine + smoking_cat_3 + imd+ ethnicity_6 + strata(subclass), df)
summary(mod3)
vif(mod3)
...
annotate(geom = "rect", xmin = -Inf,xmax = Inf,ymin = 9.5, ymax = Inf,fill="grey80", alpha=0.5)+
