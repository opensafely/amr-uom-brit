...
#xlim(c(0,2.2))+
scale_x_continuous(limits = c(0,2.2),breaks = c(1.0,1.5,2.0))+
...
annotate(geom = "rect", xmin = -Inf,xmax = Inf,ymin = 0, ymax = 1.5,fill="grey80", alpha=0.5)+
annotate(geom = "rect", xmin = -Inf,xmax = Inf,ymin = 3.5, ymax = 6.5,fill="grey80", alpha=0.5)+
annotate(geom = "rect", xmin = -Inf,xmax = Inf,ymin = 11.5, ymax = 15.5,fill="grey80", alpha=0.5)+
...
# remove AB outlier (99% percentile)
...
# remove AB outlier (90% percentile)
