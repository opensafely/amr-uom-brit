...
setDT(DF, keep.rownames = TRUE)[]
names(DF)[1]="AB_exposure"
DF$AB_exposure=factor(DF$AB_exposure,levels=c("ab_qn_type1","ab_qn_type2","ab_qn_type3","ab_qn_type4","ab_qn_type5","ab_qn_type6","ab_qn_type7","ab_qn_type8","ab_qn_type9","ab_qn_type10","ab_qn_type11","ab_qn_type12","ab_qn_type13"))
...
DF[13,1]="level4, type>=6"
 ...
 Index = rep(1:13) ## This provides an order to the data
  label = c("level1, type=1","level2, type=1","level2, type=2","level3, type=1","level3, type=2","level3, type=3","level3, type=4","level4, type=1","level4, type=2","level4, type=3","level4, type=4","level4, type=5","level4, type>=6")
...
DF[12,1]="level4, type5"
 ...
 Index = rep(1:12) ## This provides an order to the data
  label = c("level1, type1","level2, type1","level2, type2","level3, type1","level3, type2","level3, type3","level3, type4","level4, type1","level4, type2","level4, type3","level4, type4","level4, type5")
