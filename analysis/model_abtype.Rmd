...
setDT(DF, keep.rownames = TRUE)[]
names(DF)[1]="AB_exposure"
DF$AB_exposure=factor(DF$AB_exposure,levels=c("ab_qn_type1","ab_qn_type2","ab_qn_type3","ab_qn_type4","ab_qn_type5","ab_qn_type6","ab_qn_type7","ab_qn_type8","ab_qn_type9","ab_qn_type10","ab_qn_type11","ab_qn_type12","ab_qn_type13","ab_qn_type14","ab_qn_type15","ab_qn_type16","ab_qn_type17"))
...
DF[16,1]="level5, type5"
DF[17,1]="level5, type6"


 Index = rep(1:16) ## This provides an order to the data
  label = c("level1, type1","level2, type1","level2, type2","level3, type1","level3, type2","level3, type3","level4, type1","level4, type2","level4, type3","level4, type4","level4, type5","level5, type1","level5, type2","level5, type3","level5, type4","level5, type5","level5, type6")
