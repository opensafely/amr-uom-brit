...
annotate(geom = "rect", xmin = -Inf,xmax = Inf,ymin = 9.5, ymax = 12.5,fill="grey80", alpha=0.5)+
    annotate("text", x = 0.7, y =1, label = "Q1")+
    annotate("text", x = 0.7, y =2.5, label = "Q2")+
  annotate("text", x = 0.7, y =5, label = "Q3")+
  annotate("text", x = 0.7, y =8, label = "Q4")+
  annotate("text", x = 0.7, y =11, label = "Q5")+
...
p <- ggplot(data=DF, aes(y=AB_exposure, x=OR))+ 
#xlim(c(0,2.2))+
scale_x_continuous(limits = c(0.5,2.2),breaks = c(1.0,1.5,2.0))+
#scale_y_discrete(labels=c("level1, type1"="n= 1 ","level2, type1"="n= 1 ", "level2, type2"="n= 2 ","level3, type1"="n= 1 ","level3, type2"="n= 2 ","level3, type3"="n>= 3 ","level4, type1"="n= 1 ","level4, type2"="n= 2 ","level4, type3"="n>= 3 ","level5, type1"="n= 1 ","level5, type2"="n= 2 ","level5, type3"="n>= 3 ")) +
...
annotate(geom = "rect", xmin = -Inf,xmax = Inf,ymin = 3.5, ymax = 6.5,fill="grey80", alpha=0.5)+
annotate(geom = "rect", xmin = -Inf,xmax = Inf,ymin = 9.5, ymax = 12.5,fill="grey80", alpha=0.5)+
    annotate("text", x = 0, y =1, label = "Q1")+
    annotate("text", x = 0, y =2.5, label = "Q2")+
  annotate("text", x = 0, y =5, label = "Q3")+
  annotate("text", x = 0, y =8, label = "Q4")+
  annotate("text", x = 0, y =11, label = "Q5")+
  
   geom_text(aes(y = 1:15, x = 0.3, 
...
```
remove total antibiotics >= `outlier` 
