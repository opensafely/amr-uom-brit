...
###  Antibiotic use among SAR-CoV-2 positive patients ###
    ...
    Measure(
        id="covid_window_14D_window_broad",
    ...
    Measure(
        id="covid_window_7D_window_broad",
    ...
    Measure(
        id="covid_window_top5_ab_by_type",
        numerator="AB_given_14D_window",
        denominator="Positive_test_event",
    ...
    Measure(
        id="covid_window_7D_top5_ab_by_type",
        numerator="AB_given_7D_window",
        denominator="Positive_test_event",
        group_by="antibiotic_type",
    ),   
    ...
    Measure(
        id="covid_window_2D_top5_ab_by_type",
    ...
    Measure(
        id="covid_window_2D_window_broad",
