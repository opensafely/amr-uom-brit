...
df1 <- read_csv("output/sen_mortality_model_hospital_1.csv")
df2 <- read_csv("output/sen_mortality_model_hospital_2.csv")
df3 <- read_csv("output/sen_mortality_model_hospital_3.csv")
