...
write_csv(plot, here::here("output", "imd_model_18.csv"))
...
write_csv(plot, here::here("output", "imd_model_covid_18.csv"))
...
write_csv(plot, here::here("output", "imd_model_cardiometabolic_18.csv"))
