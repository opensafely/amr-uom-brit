...
relrisks1 <- result
write_csv(relrisks1, here::here("output", "sen_mortality_full_model_community_1.csv"))
...
relrisks2 <- result
write_csv(relrisks2, here::here("output", "sen_mortality_full_model_community_2.csv"))
