...
dfch <- readRDS("output/processed/input_crude_model_ch_18.rds")
dfc <- readRDS("output/processed/input_crude_model_c_18.rds")
dfh <- readRDS("output/processed/input_crude_model_h_18.rds")
...
write_csv(plota, here::here("output", "crude_plota_18.csv"))
write_csv(plotb, here::here("output", "crude_plotb_18.csv"))
