...
result20,result21,result22,result23,result24,result25)
DF=result[,-2]
names(DF)[1]="OR"
names(DF)[2]="CI_L"
names(DF)[3]="CI_U"
...
write_csv(DF, here::here("output", "crude_model_result_ch_18.csv"))

output_dir <- here("output", "processed")
fs::dir_create(output_dir)
saveRDS(object = DF,
        file = paste0(output_dir, "/input_", "crude_model_ch_18", ".rds"),
        compress = TRUE)