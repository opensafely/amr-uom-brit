...
df1 <- read_csv("output/sen_mortality_full_model_all_1.csv")
df2 <- read_csv("output/sen_mortality_full_model_all_2.csv")
df3 <- read_csv("output/sen_mortality_full_model_all_3.csv")
