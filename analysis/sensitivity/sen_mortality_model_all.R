...
relrisks1 <- result
write_csv(relrisks1, here::here("output", "sen_mortality_model_all_1.csv"))
...
relrisks2 <- result
write_csv(relrisks2, here::here("output", "sen_mortality_model_all_2.csv"))
...
relrisks3 <- result
write_csv(relrisks3, here::here("output", "sen_mortality_model_all_3.csv"))

relrisks <- merge(relrisks1,relrisks2,by = "Plot_category")
relrisks <- merge(relrisks,relrisks3,by = "Plot_category")

write_csv(relrisks, here::here("output", "sen_mortality_model_all.csv"))