...
df1 <- read_csv("output/sen_model_mortality_community_1.csv")
df2 <- read_csv("output/sen_model_mortality_community_2.csv")
df3 <- read_csv("output/sen_model_mortality_community_3.csv")
