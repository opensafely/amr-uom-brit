...
col=c("total_ab","ab_types","exposure_period" ,"recent_ab_days", "broad_prop" ,"interval_med" , "interval_CV","length_mean","length_CV",abtype)
...
#for (i in 1:nrow(result)) {
  ...
  rf.model <- randomForest(y=NULL,x=valid_X[col], 
   ...
   saveRDS(rf.model,here::here("output","model_clust.rds"))
