...
dfch <- readRDS("output/processed/input_crude_model_ch_period_2.rds")
dfc <- readRDS("output/processed/input_crude_model_c_period_2.rds")
dfh <- readRDS("output/processed/input_crude_model_h_period_2.rds")
...
write_csv(plota, here::here("output", "crude_plota_period_2.csv"))
write_csv(plotb, here::here("output", "crude_plotb_period_2.csv"))
