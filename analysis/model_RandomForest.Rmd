...
```{r}
with(train_X, qplot(total_ab,ab_types, colour=case, cex=2))
with(train_X, qplot(recent_ab_days,exposure_period, colour=case, cex=2))
with(train_X, qplot(interval_med,interval_sd, colour=case, cex=2))
with(train_X, qplot(total_ab,broad_ab_prescriptions, colour=case, cex=2))
