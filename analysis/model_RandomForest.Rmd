...
pred_col=c( "case",
             ...
             "interval_med" ,  "interval_mean" , "interval_sd" , "interval_CV",
              "length_med" , "length_mean", "length_sd" ,  "length_CV","prescribe_time_0","prescribe_time_1","prescribe_time_2","prescribe_time_3","AB_6wk_type" , "ab_6w_binary" ,
             "AB_6wk" )
...
result <- data.frame(replace = rep(c(TRUE, FALSE), each = 9),
                     sampsize = rep(c(500, 600, 700), each = 3),
                     nodesize = c(1, 5, 10),
                     valid_auc = NA)
...
for (i in 1:nrow(result)) {
  ...
  plot(roc_valid)
  roc_valid$sensitivities
  roc_valid$specificities
   rf.model
}
