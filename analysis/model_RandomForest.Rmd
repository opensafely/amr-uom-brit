...
col=c("case","prescribe_time_0","prescribe_time_1","prescribe_time_2","prescribe_time_3","ab_types","exposure_period" ,"recent_ab_days", "broad_prop" ,"interval_med" , "interval_CV","length_mean","length_CV")
# abtype
train_X=train_X[col]
valid_X=valid_X[col]
