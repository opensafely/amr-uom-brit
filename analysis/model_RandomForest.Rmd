...
col=c("case","total_ab","ab_types","exposure_period" ,"recent_ab_days", "broad_prop" ,"interval_mean" , "interval_CV",abtype)
...
```{r}
train_X[abtype]=ifelse(is.na(train_X[abtype]),0,train_X[abtype])
valid_X[abtype]=ifelse(is.na(valid_X[abtype]),0,valid_X[abtype])

train_X[abtype]=ifelse(train_X[abtype]>=1,1,train_X[abtype])
valid_X[abtype]=ifelse(valid_X[abtype]>=1,1,valid_X[abtype])
