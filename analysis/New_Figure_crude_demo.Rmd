...
df1 <- read_csv("output/crude_plota.csv")
plot.a1 <- df1 %>% filter(df1$group == "H+C")
plot.a1 <- plot.a1[c(1:4,13:16,23,22,19:21,25,26),]
plot.a2 <- df1 %>% filter(df1$group == "C")
plot.a2  <- plot.a2[c(1:4,13:16,23,22,19:21,25,26),]
plot.a3 <- df1 %>% filter(df1$group == "H")
plot.a3 <- plot.a3[c(1:4,13:16,23,22,19:21,25,26),]
...
plot.a1<- plot.a1 %>% add_row(type = "IMD", .before = 1, )
plot.a1<- plot.a1 %>% add_row(type = "Ethnicity", .before = 6, )
plot.a1<- plot.a1 %>% add_row(type = "BMI", .before = 11, )
plot.a1<- plot.a1 %>% add_row(type = "Smoking", .before = 17, )
