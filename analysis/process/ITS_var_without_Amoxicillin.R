...
write_csv(df.model, here::here("output", "df2.model_uti.csv"))
...
write_csv(df.model, here::here("output", "df2.model_asthma.csv"))
rm(df,df.all,df.broad,df.broad_total,df.model)
...
write_csv(df.model, here::here("output", "df2.model_cold.csv"))
rm(df,df.all,df.broad,df.broad_total,df.model)
...
write_csv(df.model, here::here("output", "df2.model_cough.csv"))
rm(df,df.all,df.broad,df.broad_total,df.model)
...
write_csv(df.model, here::here("output", "df2.model_copd.csv"))
rm(df,df.all,df.broad,df.broad_total,df.model)
...
write_csv(df.model, here::here("output", "df2.model_pneumonia.csv"))
rm(df,df.all,df.broad,df.broad_total,df.model)
...
write_csv(df.model, here::here("output", "df2.model_renal.csv"))
rm(df,df.all,df.broad,df.broad_total,df.model)
...
write_csv(df.model, here::here("output", "df2.model_sepsis.csv"))
rm(df,df.all,df.broad,df.broad_total,df.model)
...
write_csv(df.model, here::here("output", "df2.model_throat.csv"))
rm(df,df.all,df.broad,df.broad_total,df.model)
...
write_csv(df.model, here::here("output", "df2.model_lrti.csv"))
rm(df,df.all,df.broad,df.broad_total,df.model)
...
write_csv(df.model, here::here("output", "df2.model_urti.csv"))
rm(df,df.all,df.broad,df.broad_total,df.model)
...
write_csv(df.model, here::here("output", "df2.model_sinusitis.csv"))
rm(df,df.all,df.broad,df.broad_total,df.model)
...
write_csv(df.model, here::here("output", "df2.model_ot_media.csv"))
rm(df,df.all,df.broad,df.broad_total,df.model)
...
write_csv(df.model, here::here("output", "df2.model_ot_externa.csv"))
rm(df,df.all,df.broad,df.broad_total,df.model)
