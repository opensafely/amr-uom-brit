...
write_csv(df.model, here::here("output", "df.m2.noA.model_uti.csv"))
...
write_csv(df.model, here::here("output", "df.m2.noA.model_asthma.csv"))
rm(df,df.all,df.broad,df.broad_total,df.model)
...
write_csv(df.model, here::here("output", "df.m2.noA.model_cold.csv"))
rm(df,df.all,df.broad,df.broad_total,df.model)
...
write_csv(df.model, here::here("output", "df.m2.noA.model_cough.csv"))
rm(df,df.all,df.broad,df.broad_total,df.model)
...
write_csv(df.model, here::here("output", "df.m2.noA.model_copd.csv"))
rm(df,df.all,df.broad,df.broad_total,df.model)
...
write_csv(df.model, here::here("output", "df.m2.noA.model_pneumonia.csv"))
rm(df,df.all,df.broad,df.broad_total,df.model)
...
write_csv(df.model, here::here("output", "df.m2.noA.model_renal.csv"))
rm(df,df.all,df.broad,df.broad_total,df.model)
...
write_csv(df.model, here::here("output", "df.m2.noA.model_sepsis.csv"))
rm(df,df.all,df.broad,df.broad_total,df.model)
...
write_csv(df.model, here::here("output", "df.m2.noA.model_throat.csv"))
rm(df,df.all,df.broad,df.broad_total,df.model)
...
write_csv(df.model, here::here("output", "df.m2.noA.model_lrti.csv"))
rm(df,df.all,df.broad,df.broad_total,df.model)
...
write_csv(df.model, here::here("output", "df.m2.noA.model_urti.csv"))
rm(df,df.all,df.broad,df.broad_total,df.model)
...
write_csv(df.model, here::here("output", "df.m2.noA.model_sinusitis.csv"))
rm(df,df.all,df.broad,df.broad_total,df.model)
...
write_csv(df.model, here::here("output", "df.m2.noA.model_ot_media.csv"))
rm(df,df.all,df.broad,df.broad_total,df.model)
...
write_csv(df.model, here::here("output", "df.m2.noA.model_ot_externa.csv"))
rm(df,df.all,df.broad,df.broad_total,df.model)
...
write_csv(df.model, here::here("output", "df.m2.noA.model_uncoded.csv"))
rm(df,df.all,df.broad,df.broad_total,df.model)
