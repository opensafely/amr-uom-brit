...
ab_type=paste0("Ab_date_",rep(1:12),"_type")
  ...
  df <- read_csv(('input_antibiotics_type_pre_2018-10-01.csv.gz'),
                 col_types = cols_only(
  ...
  df <- read_csv(('input_antibiotics_type_pre_2018-11-01.csv.gz'),
                 col_types = cols_only(
                   AB_date_1 = col_date(format = ""),
                   AB_date_2 = col_date(format = ""),
                   AB_date_3 = col_date(format = ""),
  ...
  df <- read_csv(('input_antibiotics_type_pre_2018-12-01.csv.gz'),
                 col_types = cols_only(
                   AB_date_1 = col_date(format = ""),
                   AB_date_2 = col_date(format = ""),
                   AB_date_3 = col_date(format = ""),
