...
# file list
csvFiles_18 = list.files(pattern="input_antibiotics_type_pre_2018", full.names = FALSE)


# date list
date_18= seq(as.Date("2018-01-01"), as.Date("2018-12-01"), "month")
...
## save 2018 record
temp <- vector("list", length(csvFiles_18))
for (i in seq_along(csvFiles_18)){
  # read in one-month data
  df <- read_csv((csvFiles_18[i]),
                 col_types = cols_only(
