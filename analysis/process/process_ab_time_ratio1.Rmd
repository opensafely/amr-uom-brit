...
DF=read.csv(here::here("output","input_ab_time_ratio1.csv"))
nrow(DF)
names(DF)
...
df <- read_rds(here::here("output","matched_outcome_ratio1.rds"))
...
```{r}
write_rds(data, here::here("output", "matched_ab_ratio1.rds"))
```
