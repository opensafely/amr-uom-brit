---
title: "split matched patients by month"
output: 
  html_document:
   toc: true
   toc_depth: 2
...
#df=read.csv("/Users/yayang/Documents/GitHub/amr-uom-brit/output/control_covid_infection.csv")
...
for (i in 1:11) {
   ...
   print(nrow(df))
   write.csv(df, here::here("output",paste0("general_id_",index[i],".csv")))
   rm(df)
}
