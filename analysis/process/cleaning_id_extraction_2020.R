...
DF <- DF %>% filter(date <= as.Date("2020-12-31"))
DF <- DF %>% filter(age > 3)
...
write_csv(DF, here::here("output", "ab_id_date_2020.csv"))
write_csv(overall_counts, here::here("output", "num_pats_count_2020.csv"))