...
write_csv(df.model, here::here("output", "repeat_incidental_uti.csv"))
...
write_csv(df.model, here::here("output", "repeat_incidental_cold.csv"))
rm(df,df.all,df.repeat,df.repeat_total,df.model)
...
write_csv(df.model, here::here("output", "repeat_incidental_cough.csv"))
rm(df,df.all,df.repeat,df.repeat_total,df.model)
...
write_csv(df.model, here::here("output", "repeat_incidental_copd.csv"))
rm(df,df.all,df.repeat,df.repeat_total,df.model)
...
write_csv(df.model, here::here("output", "repeat_incidental_throat.csv"))
rm(df,df.all,df.repeat,df.repeat_total,df.model)
...
write_csv(df.model, here::here("output", "repeat_incidental_lrti.csv"))
rm(df,df.all,df.repeat,df.repeat_total,df.model)
...
write_csv(df.model, here::here("output", "repeat_incidental_urti.csv"))
rm(df,df.all,df.repeat,df.repeat_total,df.model)
...
write_csv(df.model, here::here("output", "repeat_incidental_sinusitis.csv"))
rm(df,df.all,df.repeat,df.repeat_total,df.model)
...
write_csv(df.model, here::here("output", "repeat_incidental_ot_media.csv"))
rm(df,df.all,df.repeat,df.repeat_total,df.model)
...
write_csv(df.model, here::here("output", "repeat_incidental_ot_externa.csv"))
rm(df,df.all,df.repeat,df.repeat_total,df.model)
rm(DF)
