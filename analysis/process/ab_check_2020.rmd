...
# file list
csvFiles_19 = list.files(path=here::here("output","measures"),pattern="input_infection_abtype_2022", full.names = FALSE)

# date list
date_19= seq(as.Date("2022-01-01"), as.Date("2022-09-01"), "month")
...
i=1
  ...
  df <- read_csv(here::here("output","measures","input_infection_abtype_2022-09-01.csv.gz"),
