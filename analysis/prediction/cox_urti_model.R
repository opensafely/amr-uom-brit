...
ggsave(plot_part6, dpi = 700,
       filename = "spline_age_urti.jpeg", path = here::here("output"))
...
jpeg(here::here("output", "urti_KM_Curves.jpeg"))
...
write_csv(pm, here::here("output", "urti_model_evaluation.csv"))
...
jpeg(here::here("output", "urti_High_Low_Risk_Patients.jpeg"))
...
jpeg(here::here("output", "urti_survival_plot_baseline_survival_curves.jpeg"))
...
jpeg(here::here("output", "urti_survival_plot_baseline_survival_curves2.jpeg"))
...
write_csv(result_coefficients, here::here("output", "urti_model_coefficients.csv"))
...
write_csv(results, here::here("output", "urti_model_HR.csv"))
...
write_csv(results, here::here("output", "urti_sex_age_band_HR.csv"))
...
write_csv(results, here::here("output", "urti_sex_age_spline_HR.csv"))
...
write_csv(all_results, here::here("output", "urti_sex_age_var_HR.csv"))
...
write_csv(results, here::here("output", "urti_sex_age_band_full_HR.csv"))
...
write_csv(pm_ext, here::here("output", "urti_model_external.csv"))
...
jpeg(here::here("output", "urti_30day_calibration.jpeg"))
...
jpeg(here::here("output", "urti_30day_re-calibration.jpeg"))
