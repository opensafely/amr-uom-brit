...
write_csv(results, here::here("output", "lrti_sex_age_band_HR.csv"))
...
write_csv(results, here::here("output", "lrti_sex_age_spline_HR.csv"))
...
write_csv(all_results, here::here("output", "lrti_sex_age_var_HR.csv"))
...
write_csv(results, here::here("output", "lrti_sex_age_band_full_HR.csv"))
