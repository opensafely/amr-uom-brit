...
ggsave(plot_part6, dpi = 700,
       filename = "spline_age_otexterna.jpeg", path = here::here("output"))
...
jpeg(here::here("output", "otexterna_KM_Curves.jpeg"))
...
write_csv(pm, here::here("output", "otexterna_model_evaluation.csv"))
...
jpeg(here::here("output", "otexterna_High_Low_Risk_Patients.jpeg"))
...
jpeg(here::here("output", "otexterna_survival_plot_baseline_survival_curves.jpeg"))
...
jpeg(here::here("output", "otexterna_survival_plot_baseline_survival_curves2.jpeg"))
...
write_csv(result_coefficients, here::here("output", "otexterna_model_coefficients.csv"))
...
write_csv(results, here::here("output", "otexterna_model_HR.csv"))
...
write_csv(results, here::here("output", "otexterna_sex_age_band_HR.csv"))
...
write_csv(results, here::here("output", "otexterna_sex_age_spline_HR.csv"))
...
write_csv(all_results, here::here("output", "otexterna_sex_age_var_HR.csv"))
...
write_csv(results, here::here("output", "otexterna_sex_age_band_full_HR.csv"))
...
write_csv(pm_ext, here::here("output", "otexterna_model_external.csv"))
...
jpeg(here::here("output", "otexterna_30day_calibration.jpeg"))
...
jpeg(here::here("output", "otexterna_30day_re-calibration.jpeg"))
