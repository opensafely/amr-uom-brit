...
ggsave(plot_part6, dpi = 700,
       filename = "spline_age_otmedia.jpeg", path = here::here("output"))
...
jpeg(here::here("output", "otmedia_KM_Curves.jpeg"))
...
write_csv(pm, here::here("output", "otmedia_model_evaluation.csv"))
...
jpeg(here::here("output", "otmedia_High_Low_Risk_Patients.jpeg"))
...
jpeg(here::here("output", "otmedia_survival_plot_baseline_survival_curves.jpeg"))
...
jpeg(here::here("output", "otmedia_survival_plot_baseline_survival_curves2.jpeg"))
...
write_csv(results, here::here("output", "otmedia_model_HR.csv"))
...
write_csv(results, here::here("output", "otmedia_sex_age_band_HR.csv"))
...
write_csv(results, here::here("output", "otmedia_sex_age_spline_HR.csv"))
...
write_csv(all_results, here::here("output", "otmedia_sex_age_var_HR.csv"))
...
write_csv(results, here::here("output", "otmedia_sex_age_band_full_HR.csv"))
...
jpeg(here::here("output", "otmedia_30day_calibration.jpeg"))
...
jpeg(here::here("output", "otmedia_30day_re-calibration.jpeg"))
