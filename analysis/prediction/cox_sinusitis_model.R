...
ggsave(plot_part6, dpi = 700,
       filename = "spline_age_sinusitis.jpeg", path = here::here("output"))
...
jpeg(here::here("output", "sinusitis_KM_Curves.jpeg"))
...
write_csv(pm, here::here("output", "sinusitis_model_evaluation.csv"))
...
jpeg(here::here("output", "sinusitis_High_Low_Risk_Patients.jpeg"))
...
jpeg(here::here("output", "sinusitis_survival_plot_baseline_survival_curves.jpeg"))
...
jpeg(here::here("output", "sinusitis_survival_plot_baseline_survival_curves2.jpeg"))
...
write_csv(result_coefficients, here::here("output", "sinusitis_model_coefficients.csv"))
...
write_csv(results, here::here("output", "sinusitis_model_HR.csv"))
...
write_csv(results, here::here("output", "sinusitis_sex_age_band_HR.csv"))
...
write_csv(results, here::here("output", "sinusitis_sex_age_spline_HR.csv"))
...
write_csv(all_results, here::here("output", "sinusitis_sex_age_var_HR.csv"))
...
write_csv(results, here::here("output", "sinusitis_sex_age_band_full_HR.csv"))
...
write_csv(pm_ext, here::here("output", "sinusitis_model_external.csv"))
...
jpeg(here::here("output", "sinusitis_30day_calibration.jpeg"))
