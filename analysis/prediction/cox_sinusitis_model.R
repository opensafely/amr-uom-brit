...
write.csv(forward_predictor_vars, here::here("output", "forward_selected_variables_sinusitis.csv"), row.names=FALSE)
write.csv(backward_predictor_vars, here::here("output", "backward_selected_variables_sinusitis.csv"), row.names=FALSE)
