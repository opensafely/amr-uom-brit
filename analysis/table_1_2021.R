...
df <- read_csv(("input_patient_characteristics_2021.csv.gz"),
                 col_types = cols_only(
                   age = col_integer(),
...
write_csv(overall_counts, here::here("output", "table1_2021_overallcount.csv"))
...
#str(t)
write_csv(t, here::here("output", "table1_2021.csv"))