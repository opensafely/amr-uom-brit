...
train$total_ab_decile=NA
for (i in 1:9) {
train$total_ab_decile=ifelse(train$total_ab > decile_value[i] & train$total_ab<=decile_value[i+1],i+1,train$total_ab_decile)  
}
  
train$total_ab_decile=ifelse(train$total_ab <= decile_value[1],1,train$total_ab_decile)

prop.table(table(train$total_ab_decile))
#}
```
