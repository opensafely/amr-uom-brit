...
# create category
col=c("case","subclass",
  "interval_sd","ab_types","prescribe_times",
...
```{r include=FALSE}
contd<- c("total_ab","exposure_period","recent_ab_days","interval_mean","ab_types","broad_ab_prescriptions")
explanatory<- c("total_ab_group","exposure_period_group","recent_ab_days_group","interval_mean_group","ab_types_group","broad_ab_prescriptions_group")
...
# Total ab
```{r include=FALSE}
## create quartiles by interval_sd_group

i=1
explanatory[i]
Q1=tapply(df[,contd[i]],df[,"interval_sd_group"],quantile,p=0.25)
Q2=tapply(df[,contd[i]],df[,"interval_sd_group"],quantile,p=0.5)
Q3=tapply(df[,contd[i]],df[,"interval_sd_group"],quantile,p=0.75)

Q1#total ab_1; interval_sd 2; total ab 3; total ab 4
Q2
Q3
```
...
df1=df%>%filter(interval_sd_group==1)
...
# total ab level 2
df2=df%>%filter(interval_sd_group==2)
...
# total ab level3
df3=df%>%filter(interval_sd_group==3)
...
# total ab level4
df4=df%>%filter(interval_sd_group==4)
...
df=df%>%mutate(ab_Level_type= 
                 case_when(
                           interval_sd_group=="1" & exposure_period_group==1 ~ 1,
                           interval_sd_group=="1" & exposure_period_group==2 ~ 2,
                           interval_sd_group=="1" & exposure_period_group==3 ~ 3,
                           interval_sd_group=="1" & exposure_period_group==4 ~ 4,
                           interval_sd_group=="2" & exposure_period_group==1 ~ 5,
                           interval_sd_group=="2" & exposure_period_group==2 ~ 6,
                           interval_sd_group=="2" & exposure_period_group==3 ~ 7,
                           interval_sd_group=="2" & exposure_period_group==4 ~ 8,
                           interval_sd_group=="3" & exposure_period_group==1 ~ 9,
                           interval_sd_group=="3" & exposure_period_group==2 ~ 10,
                           interval_sd_group=="3" & exposure_period_group==3 ~ 11,
                           interval_sd_group=="3" & exposure_period_group==4 ~ 12,
                           interval_sd_group=="4" & exposure_period_group==1 ~ 13,
                           interval_sd_group=="4" & exposure_period_group==2 ~ 14,
                           interval_sd_group=="4" & exposure_period_group==3 ~ 15,
                           interval_sd_group=="4" & exposure_period_group==4 ~ 16
...
df=df%>%mutate(ab_Level_type= 
                 case_when(
                           interval_sd_group=="1" & recent_ab_days_group==1 ~ 1,
                           interval_sd_group=="1" & recent_ab_days_group==2 ~ 2,
                           interval_sd_group=="1" & recent_ab_days_group==3 ~ 3,
                           interval_sd_group=="1" & recent_ab_days_group==4 ~ 4,
                           interval_sd_group=="2" & recent_ab_days_group==1 ~ 5,
                           interval_sd_group=="2" & recent_ab_days_group==2 ~ 6,
                           interval_sd_group=="2" & recent_ab_days_group==3 ~ 7,
                           interval_sd_group=="2" & recent_ab_days_group==4 ~ 8,
                           interval_sd_group=="3" & recent_ab_days_group==1 ~ 9,
                           interval_sd_group=="3" & recent_ab_days_group==2 ~ 10,
                           interval_sd_group=="3" & recent_ab_days_group==3 ~ 11,
                           interval_sd_group=="3" & recent_ab_days_group==4 ~ 12,
                           interval_sd_group=="4" & recent_ab_days_group==1 ~ 13,
                           interval_sd_group=="4" & recent_ab_days_group==2 ~ 14,
                           interval_sd_group=="4" & recent_ab_days_group==3 ~ 15,
                           interval_sd_group=="4" & recent_ab_days_group==4 ~ 16
...
df=df%>%mutate(ab_Level_type= 
                 case_when(
                           interval_sd_group=="1" & interval_mean_group==1 ~ 1,
                           interval_sd_group=="1" & interval_mean_group==2 ~ 2,
                           interval_sd_group=="1" & interval_mean_group==3 ~ 3,
                           interval_sd_group=="1" & interval_mean_group==4 ~ 4,
                           interval_sd_group=="2" & interval_mean_group==1 ~ 5,
                           interval_sd_group=="2" & interval_mean_group==2 ~ 6,
                           interval_sd_group=="2" & interval_mean_group==3 ~ 7,
                           interval_sd_group=="2" & interval_mean_group==4 ~ 8,
                           interval_sd_group=="3" & interval_mean_group==1 ~ 9,
                           interval_sd_group=="3" & interval_mean_group==2 ~ 10,
                           interval_sd_group=="3" & interval_mean_group==3 ~ 11,
                           interval_sd_group=="3" & interval_mean_group==4 ~ 12,
                           interval_sd_group=="4" & interval_mean_group==1 ~ 13,
                           interval_sd_group=="4" & interval_mean_group==2 ~ 14,
                           interval_sd_group=="4" & interval_mean_group==3 ~ 15,
                           interval_sd_group=="4" & interval_mean_group==4 ~ 16
...
df=df%>%mutate(ab_Level_type= 
                 case_when(
                           interval_sd_group=="1" & ab_types_group==1 ~ 1,
                           interval_sd_group=="1" & ab_types_group==2 ~ 2,
                         #  interval_sd_group=="1" & ab_types_group==3 ~ 3,
                        #   interval_sd_group=="1" & ab_types_group==4 ~ 4,
                           interval_sd_group=="2" & ab_types_group==1 ~ 5,
                        #   interval_sd_group=="2" & ab_types_group==2 ~ 6,
                           interval_sd_group=="2" & ab_types_group==3 ~ 7,
                           interval_sd_group=="2" & ab_types_group==4 ~ 8,
                           interval_sd_group=="3" & ab_types_group==1 ~ 9,
                           interval_sd_group=="3" & ab_types_group==2 ~ 10,
                           interval_sd_group=="3" & ab_types_group==3 ~ 11,
                           interval_sd_group=="3" & ab_types_group==4 ~ 12,
                           interval_sd_group=="4" & ab_types_group==1 ~ 13,
                           interval_sd_group=="4" & ab_types_group==2 ~ 14,
                           interval_sd_group=="4" & ab_types_group==3 ~ 15,
                           interval_sd_group=="4" & ab_types_group==4 ~ 16
...
df=df%>%mutate(ab_Level_type= 
                 case_when(
                           interval_sd_group=="1" & broad_ab_prescriptions_group==1 ~ 1,
                         #  interval_sd_group=="1" & broad_ab_prescriptions_group==2 ~ 2,
                         #  interval_sd_group=="1" & broad_ab_prescriptions_group==3 ~ 3,
                           interval_sd_group=="1" & broad_ab_prescriptions_group==4 ~ 4,
                           interval_sd_group=="2" & broad_ab_prescriptions_group==1 ~ 5,
                           #interval_sd_group=="2" & broad_ab_prescriptions_group==2 ~ 6,
                          # interval_sd_group=="2" & broad_ab_prescriptions_group==3 ~ 7,
                           interval_sd_group=="2" & broad_ab_prescriptions_group==4 ~ 8,
                           interval_sd_group=="3" & broad_ab_prescriptions_group==1 ~ 9,
                          # interval_sd_group=="3" & broad_ab_prescriptions_group==2 ~ 10,
                           interval_sd_group=="3" & broad_ab_prescriptions_group==3 ~ 11,
                           interval_sd_group=="3" & broad_ab_prescriptions_group==4 ~ 12,
                           interval_sd_group=="4" & broad_ab_prescriptions_group==1 ~ 13,
                          # interval_sd_group=="4" & broad_ab_prescriptions_group==2 ~ 14,
                           interval_sd_group=="4" & broad_ab_prescriptions_group==3 ~ 15,
                           interval_sd_group=="4" & broad_ab_prescriptions_group==4 ~ 16
