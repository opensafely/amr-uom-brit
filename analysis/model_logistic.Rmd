...
```{r }
model=glm(case~total_ab_group,family="binomial",x=TRUE,y=TRUE,df)

summary(model)
exp(cbind(coef(model), confint(model)))  

df$pred_y <- predict(model, df, type = 'response')
summary(df[,"pred_y"])
...
nrow(df[df$total_ab_group=="0",])
nrow(df[df$total_ab_group=="1",])

nrow(df[df$total_ab_group=="2",])
nrow(df[df$total_ab_group=="3",])
nrow(df[df$total_ab_group=="4",])


```

```{r }
model=glm(case ~ab_types_group, family="binomial",x=TRUE,y=TRUE,df)
...
for (i in 0:4) {
  print(nrow(df[df$ab_types_group==i,]))
}
```

```{r }
model=glm(case ~exposure_period_group ,family="binomial",x=TRUE,y=TRUE,df)
...
for (i in 0:4) {
  print(nrow(df[df$exposure_period_group==i,]))
}
```

```{r }
model=glm(case ~recent_ab_days_group  ,family="binomial",x=TRUE,y=TRUE,df)
...
for (i in 0:4) {
  print(summary(df[df$rerecent_ab_days_group==i, "pred_y"]))
}

for (i in 0:4) {
  print(nrow(df[df$recent_ab_days_group==i,]))
}
```

```{r }
model=glm(case ~broad_prop_group  ,family="binomial",x=TRUE,y=TRUE,df)
...
for (i in 0:4) {
  print(nrow(df[df$broad_prop_group==i,]))
}
```

```{r }
model=glm(case ~broad_ab_prescriptions_group  ,family="binomial",x=TRUE,y=TRUE,df)
...
for (i in 0:4) {
  print(nrow(df[df$broad_ab_prescriptions_group==i,]))
}
```

```{r }
model=glm(case ~interval_mean_group  ,family="binomial",x=TRUE,y=TRUE,df)
...
for (i in 0:4) {
  print(nrow(df[df$interval_mean_group==i,]))
}
```

```{r }
model=glm(case ~interval_med_group  ,family="binomial",x=TRUE,y=TRUE,df)
...
for (i in 0:4) {
  print(nrow(df[df$interval_med_group==i,]))
}
```

```{r }
model=glm(case ~ interval_CV_group ,family="binomial",x=TRUE,y=TRUE,df)
...
for (i in 0:4) {
  print(nrow(df[df$total_ab_group==i,]))
}
```

```{r }
model=glm(case ~ interval_sd_group ,family="binomial",x=TRUE,y=TRUE,df)
...
for (i in 0:4) {
  print(nrow(df[df$interval_sd_group==i,]))
}
```
...
```{r }
model=glm(case ~length_mean_group ,family="binomial",x=TRUE,y=TRUE,df)
...
for (i in 0:4) {
  print(nrow(df[df$length_mean_group==i,]))
}
```

```{r }
model=glm(case ~length_med_group ,family="binomial",x=TRUE,y=TRUE,df)
...
for (i in 0:4) {
  print(nrow(df[df$length_med_group==i,]))
}
```

```{r }
model=glm(case ~ length_CV_group,family="binomial",x=TRUE,y=TRUE,df)
...
for (i in 0:4) {
  print(nrow(df[df$length_CV_group==i,]))
}
```

```{r }
model=glm(case ~ length_sd_group,family="binomial",x=TRUE,y=TRUE,df)
...
for (i in 0:4) {
  print(nrow(df[df$length_sd_group==i,]))
}
```
