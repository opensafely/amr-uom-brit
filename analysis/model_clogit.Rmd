...
model=clogit(case ~I(total_ab)+I(ab_types)+I(exposure_period)+I(recent_ab_days)+I(broad_prop)+I(interval_mean) +I(interval_CV)+I(length_mean)+I(length_CV)+I(prescribe_time_0)+ CCI + covrx_ever + bmi_cat + care_home + flu_vaccine + smoking_cat_3 + imd+ ethnicity_6 + strata(subclass),df) 
