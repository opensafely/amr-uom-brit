...
imps %>% 
  ggplot(aes(imps, x = reorder(var, imps.score))) +
  geom_point(size = 3, colour = "grey60", ) +
  coord_flip() +
...
temp.list[[i]]<- data.frame(min,max) 
...
for (i in 1:length(explanatory)) {
  ...
  level1=paste0("(",min[1],",",max[1],")")
  level2=paste0("(",min[2],",",max[2],")")
  level3=paste0("(",min[3],",",max[3],")")
  level4=paste0("(",min[4],",",max[4],")")
