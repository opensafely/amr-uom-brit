...
valid <- read_rds(here::here("output","valid_cat.rdss"))
...
train$prob <- predict(rf.model,train, type = 'response')[,2]# votes of being case
...
valid$prob <- predict(rf.model,valid,type = 'response')[,2]# votes of being case
