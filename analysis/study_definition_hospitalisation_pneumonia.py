...
#from codelists import antibacterials_codes, broad_spectrum_antibiotics_codes, uti_codes, pneumonia_codes, ethnicity_codes, bmi_codes, any_primary_care_code, clear_smoking_codes, unclear_smoking_codes, flu_med_codes, flu_clinical_given_codes, flu_clinical_not_given_codes, covrx_code, hospitalisation_infection_related #, any_pneumonia_urti_uti_hospitalisation_codes#, flu_vaccine_codes
...
study = StudyDefinition(
    ...
    pneumonia_date_2=patients.with_these_clinical_events(
        ...
        return_expectations={"date": {"pneumonia_date_1": "today()"}},
        ),
    ...
    pneumonia_date_5=patients.with_these_clinical_events(
        pneumonia_codes,
        returning='date',
    ...
    pneumonia_date_6=patients.with_these_clinical_events(
        pneumonia_codes,
        returning='date',
    ...
    pneumonia_date_7=patients.with_these_clinical_events(
        pneumonia_codes,
        returning='date',
    ...
    pneumonia_date_8=patients.with_these_clinical_events(
        pneumonia_codes,
        returning='date',
    ...
    pneumonia_date_9=patients.with_these_clinical_events(
        pneumonia_codes,
        returning='date',
    ...
    pneumonia_date_10=patients.with_these_clinical_events(
        pneumonia_codes,
        returning='date',
    ...
    pneumonia_date_11=patients.with_these_clinical_events(
        pneumonia_codes,
        returning='date',
    ...
    pneumonia_date_12=patients.with_these_clinical_events(
        pneumonia_codes,
        returning='date',
    ...
    pneumonia_date_13=patients.with_these_clinical_events(
        pneumonia_codes,
        returning='date',
    ...
    pneumonia_date_14=patients.with_these_clinical_events(
        pneumonia_codes,
        returning='date',
    ...
    pneumonia_date_15=patients.with_these_clinical_events(
        pneumonia_codes,
        returning='date',
...
#     ),
    ...
    incdt_pneumonia_date_2=patients.with_these_clinical_events(
        pneumonia_codes,
        returning="binary_flag",
        between=["pneumonia_date_2 - 42 days", "pneumonia_date_2 - 1 day"],
        find_first_match_in_period=True,
        return_expectations={"incidence": 0.1, "date": {"earliest": "index_date - 42 days"}}
    ),

    incdt_pneumonia_date_3=patients.with_these_clinical_events(
        pneumonia_codes,
        returning="binary_flag",
        between=["pneumonia_date_3 - 42 days", "pneumonia_date_3 - 1 day"], 
        find_first_match_in_period=True,
        return_expectations={"incidence": 0.1, "date": {"earliest": "index_date - 42 days"}}
    ),

    incdt_pneumonia_date_4=patients.with_these_clinical_events(
        pneumonia_codes,
        returning="binary_flag",
        between=["pneumonia_date_4 - 42 days", "pneumonia_date_4 - 1 day"], 
        find_first_match_in_period=True,
        return_expectations={"incidence": 0.1, "date": {"earliest": "index_date - 42 days"}}
    ),

    incdt_pneumonia_date_5=patients.with_these_clinical_events(
        pneumonia_codes,
        returning="binary_flag",
        between=["pneumonia_date_5 - 42 days", "pneumonia_date_5 - 1 day"], 
        find_first_match_in_period=True,
        return_expectations={"incidence": 0.1, "date": {"earliest": "index_date - 42 days"}}
    ),

    incdt_pneumonia_date_6=patients.with_these_clinical_events(
        pneumonia_codes,
        returning="binary_flag",
        between=["pneumonia_date_6 - 42 days", "pneumonia_date_6 - 1 day"], 
        find_first_match_in_period=True,
        return_expectations={"incidence": 0.1, "date": {"earliest": "index_date - 42 days"}}
    ),

    incdt_pneumonia_date_7=patients.with_these_clinical_events(
        pneumonia_codes,
        returning="binary_flag",
        between=["pneumonia_date_7 - 42 days", "pneumonia_date_7 - 1 day"], 
        find_first_match_in_period=True,
        return_expectations={"incidence": 0.1, "date": {"earliest": "index_date - 42 days"}}
    ),

    incdt_pneumonia_date_8=patients.with_these_clinical_events(
        pneumonia_codes,
        returning="binary_flag",
        between=["pneumonia_date_8 - 42 days", "pneumonia_date_8 - 1 day"], 
        find_first_match_in_period=True,
        return_expectations={"incidence": 0.1, "date": {"earliest": "index_date - 42 days"}}
    ),

    incdt_pneumonia_date_9=patients.with_these_clinical_events(
        pneumonia_codes,
        returning="binary_flag",
        between=["pneumonia_date_9 - 42 days", "pneumonia_date_9 - 1 day"], 
        find_first_match_in_period=True,
        return_expectations={"incidence": 0.1, "date": {"earliest": "index_date - 42 days"}}
    ),

    incdt_pneumonia_date_10=patients.with_these_clinical_events(
        pneumonia_codes,
        returning="binary_flag",
        between=["pneumonia_date_10 - 42 days", "pneumonia_date_10 - 1 day"], 
        find_first_match_in_period=True,
        return_expectations={"incidence": 0.1, "date": {"earliest": "index_date - 42 days"}}
    ),

    incdt_pneumonia_date_11=patients.with_these_clinical_events(
        pneumonia_codes,
        returning="binary_flag",
        between=["pneumonia_date_11 - 42 days", "pneumonia_date_1 - 11 day"],
        find_first_match_in_period=True,
        return_expectations={"incidence": 0.1, "date": {"earliest": "index_date - 42 days"}}
    ),

    incdt_pneumonia_date_12=patients.with_these_clinical_events(
        pneumonia_codes,
        returning="binary_flag",
        between=["pneumonia_date_12 - 42 days", "pneumonia_date_12 - 1 day"],
        find_first_match_in_period=True,
        return_expectations={"incidence": 0.1, "date": {"earliest": "index_date - 42 days"}}
    ),

    incdt_pneumonia_date_13=patients.with_these_clinical_events(
        pneumonia_codes,
        returning="binary_flag",
        between=["pneumonia_date_13 - 42 days", "pneumonia_date_13 - 1 day"], 
        find_first_match_in_period=True,
        return_expectations={"incidence": 0.1, "date": {"earliest": "index_date - 42 days"}}
    ),

    incdt_pneumonia_date_14=patients.with_these_clinical_events(
        pneumonia_codes,
        returning="binary_flag",
        between=["pneumonia_date_14 - 42 days", "pneumonia_date_14 - 1 day"], 
        find_first_match_in_period=True,
        return_expectations={"incidence": 0.1, "date": {"earliest": "index_date - 42 days"}}
    ),

    incdt_pneumonia_date_15=patients.with_these_clinical_events(
        pneumonia_codes,
        returning="binary_flag",
        between=["pneumonia_date_15 - 42 days", "pneumonia_date_15 - 1 day"], 
        find_first_match_in_period=True,
        return_expectations={"incidence": 0.1, "date": {"earliest": "index_date - 42 days"}}
    ),
...
## hospitalisation with incident OR prevalent pneumonia
    admitted_pneumonia_date_1=patients.admitted_to_hospital(
       with_these_diagnoses=hospitalisation_infection_related,
       returning="date_admitted",
       date_format="YYYY-MM-DD",
       between=["pneumonia_date_1", "pneumonia_date_1 + 30 days"], #["pneumonia_date_1", "pneumonia_date_1 + 30 days"]
       find_first_match_in_period=True,
       return_expectations={"incidence": 0.3},
    ),

    admitted_pneumonia_date_2=patients.admitted_to_hospital(
       with_these_diagnoses=hospitalisation_infection_related,
       returning="date_admitted",
       date_format="YYYY-MM-DD",
       between=["pneumonia_date_2", "pneumonia_date_2 + 30 days"], #["pneumonia_date_2", "pneumonia_date_2 + 30 days"]
       find_first_match_in_period=True,
       return_expectations={"incidence": 0.3},
    ),

    admitted_pneumonia_date_3=patients.admitted_to_hospital(
       with_these_diagnoses=hospitalisation_infection_related,
       returning="date_admitted",
       date_format="YYYY-MM-DD",
       between=["pneumonia_date_3", "pneumonia_date_3 + 30 days"], #["pneumonia_date_3", "pneumonia_date_3 + 30 days"]
       find_first_match_in_period=True,
       return_expectations={"incidence": 0.3},
    ),

    admitted_pneumonia_date_4=patients.admitted_to_hospital(
       with_these_diagnoses=hospitalisation_infection_related,
       returning="date_admitted",
       date_format="YYYY-MM-DD",
       between=["pneumonia_date_4", "pneumonia_date_4 + 30 days"], #["pneumonia_date_4", "pneumonia_date_4 + 30 days"]
       find_first_match_in_period=True,
       return_expectations={"incidence": 0.3},
    ),

    admitted_pneumonia_date_5=patients.admitted_to_hospital(
       with_these_diagnoses=hospitalisation_infection_related,
       returning="date_admitted",
       date_format="YYYY-MM-DD",
       between=["pneumonia_date_5", "pneumonia_date_5 + 30 days"],
       find_first_match_in_period=True,
       return_expectations={"incidence": 0.3},
    ),

    admitted_pneumonia_date_6=patients.admitted_to_hospital(
       with_these_diagnoses=hospitalisation_infection_related,
       returning="date_admitted",
       date_format="YYYY-MM-DD",
       between=["pneumonia_date_6", "pneumonia_date_6 + 30 days"],
       find_first_match_in_period=True,
       return_expectations={"incidence": 0.3},
    ),

    admitted_pneumonia_date_7=patients.admitted_to_hospital(
       with_these_diagnoses=hospitalisation_infection_related,
       returning="date_admitted",
       date_format="YYYY-MM-DD",
       between=["pneumonia_date_7", "pneumonia_date_7 + 30 days"],
       find_first_match_in_period=True,
       return_expectations={"incidence": 0.3},
    ),

    admitted_pneumonia_date_8=patients.admitted_to_hospital(
       with_these_diagnoses=hospitalisation_infection_related,
       returning="date_admitted",
       date_format="YYYY-MM-DD",
       between=["pneumonia_date_8", "pneumonia_date_8 + 30 days"],
       find_first_match_in_period=True,
       return_expectations={"incidence": 0.3},
    ),

    admitted_pneumonia_date_9=patients.admitted_to_hospital(
       with_these_diagnoses=hospitalisation_infection_related,
       returning="date_admitted",
       date_format="YYYY-MM-DD",
       between=["pneumonia_date_9", "pneumonia_date_9 + 30 days"],
       find_first_match_in_period=True,
       return_expectations={"incidence": 0.3},
    ),

    admitted_pneumonia_date_10=patients.admitted_to_hospital(
       with_these_diagnoses=hospitalisation_infection_related,
       returning="date_admitted",
       date_format="YYYY-MM-DD",
       between=["pneumonia_date_10", "pneumonia_date_10 + 30 days"],
       find_first_match_in_period=True,
       return_expectations={"incidence": 0.3},
    ),

    admitted_pneumonia_date_11=patients.admitted_to_hospital(
       with_these_diagnoses=hospitalisation_infection_related,
       returning="date_admitted",
       date_format="YYYY-MM-DD",
       between=["pneumonia_date_11", "pneumonia_date_11 + 30 days"], 
       find_first_match_in_period=True,
       return_expectations={"incidence": 0.3},
    ),

    admitted_pneumonia_date_12=patients.admitted_to_hospital(
       with_these_diagnoses=hospitalisation_infection_related,
       returning="date_admitted",
       date_format="YYYY-MM-DD",
       between=["pneumonia_date_12", "pneumonia_date_12 + 30 days"],
       find_first_match_in_period=True,
       return_expectations={"incidence": 0.3},
    ),

    admitted_pneumonia_date_13=patients.admitted_to_hospital(
       with_these_diagnoses=hospitalisation_infection_related,
       returning="date_admitted",
       date_format="YYYY-MM-DD",
       between=["pneumonia_date_13", "pneumonia_date_13 + 30 days"],
       find_first_match_in_period=True,
       return_expectations={"incidence": 0.3},
    ),

    admitted_pneumonia_date_14=patients.admitted_to_hospital(
       with_these_diagnoses=hospitalisation_infection_related,
       returning="date_admitted",
       date_format="YYYY-MM-DD",
       between=["pneumonia_date_14", "pneumonia_date_14 + 30 days"], 
       find_first_match_in_period=True,
       return_expectations={"incidence": 0.3},
    ),

    admitted_pneumonia_date_15=patients.admitted_to_hospital(
       with_these_diagnoses=hospitalisation_infection_related,
       returning="date_admitted",
       date_format="YYYY-MM-DD",
       between=["pneumonia_date_15", "pneumonia_date_15 + 30 days"],
       find_first_match_in_period=True,
       return_expectations={"incidence": 0.3},
    ),
    ...
    sgss_pos_covid_date_pneumonia_1=patients.with_test_result_in_sgss(
        pathogen="SARS-CoV-2",
        test_result="positive",
        between=["pneumonia_date_1 - 90 days", "pneumonia_date_1 + 30 days"],
        find_first_match_in_period=True,
        returning="date",
        date_format="YYYY-MM-DD",
    ...
    ## Covid diagnosis during hospital admission related to pneumonia
    gp_covid_date_pneumonia_1=patients.with_these_clinical_events(
    ...
    sgss_gp_cov_pneumonia_date_1=patients.satisfying(
        """
        sgss_pos_covid_date_pneumonia_1 OR
        gp_covid_date_pneumonia_1
        """,
    ),

    ## Covid positive test result
    sgss_pos_covid_date_pneumonia_2=patients.with_test_result_in_sgss(
        pathogen="SARS-CoV-2",
        test_result="positive",
        between=["pneumonia_date_2 - 90 days", "pneumonia_date_2 + 30 days"],
        find_first_match_in_period=True,
        returning="date",
        date_format="YYYY-MM-DD",
        return_expectations={"incidence": 0.5},
    ...
    ## Covid diagnosis
    gp_covid_date_pneumonia_2=patients.with_these_clinical_events(
        any_primary_care_code,
        returning="date",
        between=["pneumonia_date_2 - 90 days", "pneumonia_date_2 + 30 days"],
        find_first_match_in_period=True,
    ...
    ## Covid diagnosis either recorded in sgss or diagnosed by gp within 90 days before and 30 days after pneumonia dx 
    sgss_gp_cov_pneumonia_date_2=patients.satisfying(
        """
        sgss_pos_covid_date_pneumonia_2 OR
        gp_covid_date_pneumonia_2
        """,
    ),

    ## Covid positive test result 3
    sgss_pos_covid_date_pneumonia_3=patients.with_test_result_in_sgss(
        pathogen="SARS-CoV-2",
        test_result="positive",
        between=["pneumonia_date_3 - 90 days", "pneumonia_date_3 + 30 days"],
        find_first_match_in_period=True,
        returning="date",
        date_format="YYYY-MM-DD",
        return_expectations={"incidence": 0.5},
    ...
    ## Covid diagnosis
    gp_covid_date_pneumonia_3=patients.with_these_clinical_events(
        any_primary_care_code,
        returning="date",
        between=["pneumonia_date_3 - 90 days", "pneumonia_date_3 + 30 days"],
        find_first_match_in_period=True,
    ...
    ## Covid diagnosis either recorded in sgss or diagnosed by gp within 90 days before and 30 days after pneumonia dx 
    sgss_gp_cov_pneumonia_date_3=patients.satisfying(
        """
        sgss_pos_covid_date_pneumonia_3 OR
        gp_covid_date_pneumonia_3
        """,
    ),

    ## Covid positive test result
    sgss_pos_covid_date_pneumonia_4=patients.with_test_result_in_sgss(
        pathogen="SARS-CoV-2",
        test_result="positive",
        between=["pneumonia_date_4 - 90 days", "pneumonia_date_4 + 30 days"],
        find_first_match_in_period=True,
        returning="date",
        date_format="YYYY-MM-DD",
        return_expectations={"incidence": 0.5},
    ...
    ## Covid diagnosis
    gp_covid_date_pneumonia_4=patients.with_these_clinical_events(
        any_primary_care_code,
        returning="date",
        between=["pneumonia_date_4 - 90 days", "pneumonia_date_4 + 30 days"],
        find_first_match_in_period=True,
    ...
    ## Covid diagnosis either recorded in sgss or diagnosed by gp within 90 days before and 30 days after pneumonia dx 
    sgss_gp_cov_pneumonia_date_4=patients.satisfying(
        """
        sgss_pos_covid_date_pneumonia_4 OR
        gp_covid_date_pneumonia_4
        """,
    ),
...
########################################
    ...
    sgss_pos_covid_date_pneumonia_5=patients.with_test_result_in_sgss(
        pathogen="SARS-CoV-2",
        test_result="positive",
        between=["pneumonia_date_5 - 90 days", "pneumonia_date_5 + 30 days"],
        find_first_match_in_period=True,
        returning="date",
        date_format="YYYY-MM-DD",
        return_expectations={"incidence": 0.5},
    ...
    ## Covid diagnosis
    gp_covid_date_pneumonia_5=patients.with_these_clinical_events(
        any_primary_care_code,
        returning="date",
        between=["pneumonia_date_5 - 90 days", "pneumonia_date_5 + 30 days"],
        find_first_match_in_period=True,
    ...
    ## Covid diagnosis either recorded in sgss or diagnosed by gp within 90 days before and 30 days after pneumonia dx 
    sgss_gp_cov_pneumonia_date_5=patients.satisfying(
        """
        sgss_pos_covid_date_pneumonia_5 OR
        gp_covid_date_pneumonia_5
        """,
    ),
...
########################################
    ...
    sgss_pos_covid_date_pneumonia_6=patients.with_test_result_in_sgss(
        pathogen="SARS-CoV-2",
        test_result="positive",
        between=["pneumonia_date_6 - 90 days", "pneumonia_date_6 + 30 days"],
        find_first_match_in_period=True,
        returning="date",
        date_format="YYYY-MM-DD",
        return_expectations={"incidence": 0.5},
    ...
    ## Covid diagnosis
    gp_covid_date_pneumonia_6=patients.with_these_clinical_events(
        any_primary_care_code,
        returning="date",
        between=["pneumonia_date_6 - 90 days", "pneumonia_date_6 + 30 days"],
        find_first_match_in_period=True,
    ...
    ## Covid diagnosis either recorded in sgss or diagnosed by gp within 90 days before and 30 days after pneumonia dx 
    sgss_gp_cov_pneumonia_date_6=patients.satisfying(
        """
        sgss_pos_covid_date_pneumonia_6 OR
...
########################################
    ...
    sgss_pos_covid_date_pneumonia_7=patients.with_test_result_in_sgss(
        pathogen="SARS-CoV-2",
        test_result="positive",
        between=["pneumonia_date_7 - 90 days", "pneumonia_date_7 + 30 days"],
        find_first_match_in_period=True,
        returning="date",
        date_format="YYYY-MM-DD",
        return_expectations={"incidence": 0.5},
    ...
    ## Covid diagnosis
    gp_covid_date_pneumonia_7=patients.with_these_clinical_events(
        any_primary_care_code,
        returning="date",
        between=["pneumonia_date_7 - 90 days", "pneumonia_date_7 + 30 days"],
        find_first_match_in_period=True,
    ...
    ## Covid diagnosis either recorded in sgss or diagnosed by gp within 90 days before and 30 days after pneumonia dx 
    sgss_gp_cov_pneumonia_date_7=patients.satisfying(
        """
        sgss_pos_covid_date_pneumonia_7 OR
        gp_covid_date_pneumonia_7
        """,
    ),
...
########################################
    ...
    sgss_pos_covid_date_pneumonia_8=patients.with_test_result_in_sgss(
        pathogen="SARS-CoV-2",
        test_result="positive",
        between=["pneumonia_date_8 - 90 days", "pneumonia_date_8 + 30 days"],
        find_first_match_in_period=True,
        returning="date",
        date_format="YYYY-MM-DD",
        return_expectations={"incidence": 0.5},
    ...
    ## Covid diagnosis
    gp_covid_date_pneumonia_8=patients.with_these_clinical_events(
        any_primary_care_code,
        returning="date",
        between=["pneumonia_date_8 - 90 days", "pneumonia_date_8 + 30 days"],
        find_first_match_in_period=True,
    ...
    ## Covid diagnosis either recorded in sgss or diagnosed by gp within 90 days before and 30 days after pneumonia dx 
    sgss_gp_cov_pneumonia_date_8=patients.satisfying(
        """
        sgss_pos_covid_date_pneumonia_8 OR
        gp_covid_date_pneumonia_8
        """,
    ),
...
########################################
    ...
    sgss_pos_covid_date_pneumonia_9=patients.with_test_result_in_sgss(
        pathogen="SARS-CoV-2",
        test_result="positive",
        between=["pneumonia_date_9 - 90 days", "pneumonia_date_9 + 30 days"],
        find_first_match_in_period=True,
        returning="date",
        date_format="YYYY-MM-DD",
        return_expectations={"incidence": 0.5},
    ...
    ## Covid diagnosis
    gp_covid_date_pneumonia_9=patients.with_these_clinical_events(
        any_primary_care_code,
        returning="date",
        between=["pneumonia_date_9 - 90 days", "pneumonia_date_9 + 30 days"],
        find_first_match_in_period=True,
    ...
    ## Covid diagnosis either recorded in sgss or diagnosed by gp within 90 days before and 30 days after pneumonia dx 
    sgss_gp_cov_pneumonia_date_9=patients.satisfying(
        """
        sgss_pos_covid_date_pneumonia_9 OR
        gp_covid_date_pneumonia_9
        """,
    ),
...
########################################
    ...
    sgss_pos_covid_date_pneumonia_10=patients.with_test_result_in_sgss(
        pathogen="SARS-CoV-2",
        test_result="positive",
        between=["pneumonia_date_10 - 90 days", "pneumonia_date_10 + 30 days"],
        find_first_match_in_period=True,
        returning="date",
        date_format="YYYY-MM-DD",
        return_expectations={"incidence": 0.5},
    ...
    ## Covid diagnosis
    gp_covid_date_pneumonia_10=patients.with_these_clinical_events(
        any_primary_care_code,
        returning="date",
        between=["pneumonia_date_10 - 90 days", "pneumonia_date_10 + 30 days"],
        find_first_match_in_period=True,
    ...
    ## Covid diagnosis either recorded in sgss or diagnosed by gp within 90 days before and 30 days after pneumonia dx 
    sgss_gp_cov_pneumonia_date_10=patients.satisfying(
        """
        sgss_pos_covid_date_pneumonia_10 OR
        gp_covid_date_pneumonia_10
        """,
    ),
...
########################################
    ...
    sgss_pos_covid_date_pneumonia_11=patients.with_test_result_in_sgss(
        pathogen="SARS-CoV-2",
        test_result="positive",
        between=["pneumonia_date_11 - 90 days", "pneumonia_date_11 + 30 days"],
        find_first_match_in_period=True,
        returning="date",
        date_format="YYYY-MM-DD",
        return_expectations={"incidence": 0.5},
    ...
    ## Covid diagnosis
    gp_covid_date_pneumonia_11=patients.with_these_clinical_events(
        any_primary_care_code,
        returning="date",
        between=["pneumonia_date_11 - 90 days", "pneumonia_date_11 + 30 days"],
        find_first_match_in_period=True,
    ...
    ## Covid diagnosis either recorded in sgss or diagnosed by gp within 90 days before and 30 days after pneumonia dx 
    sgss_gp_cov_pneumonia_date_11=patients.satisfying(
        """
        sgss_pos_covid_date_pneumonia_11 OR
        gp_covid_date_pneumonia_11
        """,
    ),
...
########################################
    ...
    sgss_pos_covid_date_pneumonia_12=patients.with_test_result_in_sgss(
        pathogen="SARS-CoV-2",
        test_result="positive",
        between=["pneumonia_date_12 - 90 days", "pneumonia_date_12 + 30 days"],
        find_first_match_in_period=True,
        returning="date",
        date_format="YYYY-MM-DD",
        return_expectations={"incidence": 0.5},
    ...
    ## Covid diagnosis
    gp_covid_date_pneumonia_12=patients.with_these_clinical_events(
        any_primary_care_code,
        returning="date",
        between=["pneumonia_date_12 - 90 days", "pneumonia_date_12 + 30 days"],
        find_first_match_in_period=True,
    ...
    ## Covid diagnosis either recorded in sgss or diagnosed by gp within 90 days before and 30 days after pneumonia dx 
    sgss_gp_cov_pneumonia_date_12=patients.satisfying(
        """
        sgss_pos_covid_date_pneumonia_12 OR
        gp_covid_date_pneumonia_12
        """,
    ),
...
########################################
    ...
    sgss_pos_covid_date_pneumonia_13=patients.with_test_result_in_sgss(
        pathogen="SARS-CoV-2",
        test_result="positive",
        between=["pneumonia_date_13 - 90 days", "pneumonia_date_13 + 30 days"],
        find_first_match_in_period=True,
        returning="date",
        date_format="YYYY-MM-DD",
        return_expectations={"incidence": 0.5},
    ...
    ## Covid diagnosis
    gp_covid_date_pneumonia_13=patients.with_these_clinical_events(
        any_primary_care_code,
        returning="date",
        between=["pneumonia_date_13 - 90 days", "pneumonia_date_13 + 30 days"],
        find_first_match_in_period=True,
    ...
    ## Covid diagnosis either recorded in sgss or diagnosed by gp within 90 days before and 30 days after pneumonia dx 
    sgss_gp_cov_pneumonia_date_13=patients.satisfying(
        """
        sgss_pos_covid_date_pneumonia_13 OR
        gp_covid_date_pneumonia_13
        """,
    ),
...
########################################
    ...
    sgss_pos_covid_date_pneumonia_14=patients.with_test_result_in_sgss(
        pathogen="SARS-CoV-2",
        test_result="positive",
        between=["pneumonia_date_14 - 90 days", "pneumonia_date_14 + 30 days"],
        find_first_match_in_period=True,
        returning="date",
        date_format="YYYY-MM-DD",
        return_expectations={"incidence": 0.5},
    ...
    ## Covid diagnosis
    gp_covid_date_pneumonia_14=patients.with_these_clinical_events(
        any_primary_care_code,
        returning="date",
        between=["pneumonia_date_14 - 90 days", "pneumonia_date_14 + 30 days"],
        find_first_match_in_period=True,
    ...
    ## Covid diagnosis either recorded in sgss or diagnosed by gp within 90 days before and 30 days after pneumonia dx 
    sgss_gp_cov_pneumonia_date_14=patients.satisfying(
        """
        sgss_pos_covid_date_pneumonia_14 OR
        gp_covid_date_pneumonia_14
        """,
    ),
...
########################################
    ...
    sgss_pos_covid_date_pneumonia_15=patients.with_test_result_in_sgss(
        pathogen="SARS-CoV-2",
        test_result="positive",
        between=["pneumonia_date_15 - 90 days", "pneumonia_date_15 + 30 days"],
        find_first_match_in_period=True,
        returning="date",
        date_format="YYYY-MM-DD",
        return_expectations={"incidence": 0.5},
    ...
    ## Covid diagnosis
    gp_covid_date_pneumonia_15=patients.with_these_clinical_events(
        any_primary_care_code,
        returning="date",
        between=["pneumonia_date_15 - 90 days", "pneumonia_date_15 + 30 days"],
        find_first_match_in_period=True,
    ...
    ## Covid diagnosis either recorded in sgss or diagnosed by gp within 90 days before and 30 days after pneumonia dx 
    sgss_gp_cov_pneumonia_date_15=patients.satisfying(
        """
        sgss_pos_covid_date_pneumonia_15 OR
        gp_covid_date_pneumonia_15
        """,
    ),
...
########################################
    ...
    pneumonia_ab_date_2=patients.with_these_medications(
        antibacterials_codes_brit,
        between=['pneumonia_date_2','pneumonia_date_2 + 5 days'],
        returning='date',
        date_format="YYYY-MM-DD",
        return_expectations={"incidence": 0.1, "date": {"earliest": start_date}},
        ),

    pneumonia_ab_date_3=patients.with_these_medications(
        antibacterials_codes_brit,
        between=['pneumonia_date_3','pneumonia_date_3 + 5 days'],
        returning='date',
        date_format="YYYY-MM-DD",
        return_expectations={"incidence": 0.1, "date": {"earliest": start_date}},
        ),

    pneumonia_ab_date_4=patients.with_these_medications(
        antibacterials_codes_brit,
        between=['pneumonia_date_4','pneumonia_date_4 + 5 days'],
        returning='date',
        date_format="YYYY-MM-DD",
        return_expectations={"incidence": 0.1, "date": {"earliest": start_date}},
        ),

    pneumonia_ab_date_5=patients.with_these_medications(
        antibacterials_codes_brit,
        between=['pneumonia_date_5','pneumonia_date_5 + 5 days'],
        returning='date',
        date_format="YYYY-MM-DD",
        return_expectations={"incidence": 0.1, "date": {"earliest": start_date}},
        ),

    pneumonia_ab_date_6=patients.with_these_medications(
        antibacterials_codes_brit,
        between=['pneumonia_date_6','pneumonia_date_6 + 5 days'],
        returning='date',
        date_format="YYYY-MM-DD",
        return_expectations={"incidence": 0.1, "date": {"earliest": start_date}},
        ),

    pneumonia_ab_date_7=patients.with_these_medications(
        antibacterials_codes_brit,
        between=['pneumonia_date_7','pneumonia_date_7 + 5 days'],
        returning='date',
        date_format="YYYY-MM-DD",
        return_expectations={"incidence": 0.1, "date": {"earliest": start_date}},
        ),

    pneumonia_ab_date_8=patients.with_these_medications(
        antibacterials_codes_brit,
        between=['pneumonia_date_8','pneumonia_date_8 + 5 days'],
        returning='date',
        date_format="YYYY-MM-DD",
        return_expectations={"incidence": 0.1, "date": {"earliest": start_date}},
        ),

    pneumonia_ab_date_9=patients.with_these_medications(
        antibacterials_codes_brit,
        between=['pneumonia_date_9','pneumonia_date_9 + 5 days'],
        returning='date',
        date_format="YYYY-MM-DD",
        return_expectations={"incidence": 0.1, "date": {"earliest": start_date}},
        ),

    pneumonia_ab_date_10=patients.with_these_medications(
        antibacterials_codes_brit,
        between=['pneumonia_date_10','pneumonia_date_10 + 5 days'],
        returning='date',
        date_format="YYYY-MM-DD",
        return_expectations={"incidence": 0.1, "date": {"earliest": start_date}},
        ),

    pneumonia_ab_date_11=patients.with_these_medications(
        antibacterials_codes_brit,
        between=['pneumonia_date_11','pneumonia_date_11 + 5 days'],
        returning='date',
        date_format="YYYY-MM-DD",
        return_expectations={"incidence": 0.1, "date": {"earliest": start_date}},
        ),

    pneumonia_ab_date_12=patients.with_these_medications(
        antibacterials_codes_brit,
        between=['pneumonia_date_12','pneumonia_date_12 + 5 days'],
        returning='date',
        date_format="YYYY-MM-DD",
        return_expectations={"incidence": 0.1, "date": {"earliest": start_date}},
        ),

    pneumonia_ab_date_13=patients.with_these_medications(
        antibacterials_codes_brit,
        between=['pneumonia_date_13','pneumonia_date_13 + 5 days'],
        returning='date',
        date_format="YYYY-MM-DD",
        return_expectations={"incidence": 0.1, "date": {"earliest": start_date}},
        ),

    pneumonia_ab_date_14=patients.with_these_medications(
        antibacterials_codes_brit,
        between=['pneumonia_date_14','pneumonia_date_14 + 5 days'],
        returning='date',
        date_format="YYYY-MM-DD",
        return_expectations={"incidence": 0.1, "date": {"earliest": start_date}},
        ),

    pneumonia_ab_date_15=patients.with_these_medications(
        antibacterials_codes_brit,
        between=['pneumonia_date_15','pneumonia_date_15 + 5 days'],
        returning='date',
        date_format="YYYY-MM-DD",
        return_expectations={"incidence": 0.1, "date": {"earliest": start_date}},
        ),
    ...
    pneumonia_ab_type_2=patients.with_these_medications(
        antibacterials_codes_brit,
        between=['pneumonia_date_2','pneumonia_date_2 + 5 days'],
        returning='category',
        return_expectations={"category": {"ratios": {"Doxycycline":0.1, "Cefoxitin":0.05, "Aztreonam":0.05, 
    ...
    pneumonia_ab_type_3=patients.with_these_medications(
        antibacterials_codes_brit,
        between=['pneumonia_date_3','pneumonia_date_3 + 5 days'],
        returning='category',
        return_expectations={"category": {"ratios": {"Doxycycline":0.1, "Cefoxitin":0.05, "Aztreonam":0.05, 
    ...
    pneumonia_ab_type_4=patients.with_these_medications(
        antibacterials_codes_brit,
        between=['pneumonia_date_4','pneumonia_date_4 + 5 days'],
        returning='category',
        return_expectations={"category": {"ratios": {"Doxycycline":0.1, "Cefoxitin":0.05, "Aztreonam":0.05, 
    ...
    pneumonia_ab_type_5=patients.with_these_medications(
        antibacterials_codes_brit,
        between=['pneumonia_date_5','pneumonia_date_5 + 5 days'],
        returning='category',
        return_expectations={"category": {"ratios": {"Doxycycline":0.1, "Cefoxitin":0.05, "Aztreonam":0.05, 
    ...
    pneumonia_ab_type_6=patients.with_these_medications(
        antibacterials_codes_brit,
        between=['pneumonia_date_6','pneumonia_date_6 + 5 days'],
        returning='category',
        return_expectations={"category": {"ratios": {"Doxycycline":0.1, "Cefoxitin":0.05, "Aztreonam":0.05, 
    ...
    pneumonia_ab_type_7=patients.with_these_medications(
        antibacterials_codes_brit,
        between=['pneumonia_date_7','pneumonia_date_7 + 5 days'],
        returning='category',
        return_expectations={"category": {"ratios": {"Doxycycline":0.1, "Cefoxitin":0.05, "Aztreonam":0.05, 
    ...
    pneumonia_ab_type_8=patients.with_these_medications(
        antibacterials_codes_brit,
        between=['pneumonia_date_8','pneumonia_date_8 + 5 days'],
        returning='category',
        return_expectations={"category": {"ratios": {"Doxycycline":0.1, "Cefoxitin":0.05, "Aztreonam":0.05, 
    ...
    pneumonia_ab_type_9=patients.with_these_medications(
        antibacterials_codes_brit,
        between=['pneumonia_date_9','pneumonia_date_9 + 5 days'],
        returning='category',
        return_expectations={"category": {"ratios": {"Doxycycline":0.1, "Cefoxitin":0.05, "Aztreonam":0.05, 
    ...
    pneumonia_ab_type_10=patients.with_these_medications(
        antibacterials_codes_brit,
        between=['pneumonia_date_10','pneumonia_date_10 + 5 days'],
        returning='category',
        return_expectations={"category": {"ratios": {"Doxycycline":0.1, "Cefoxitin":0.05, "Aztreonam":0.05, 
    ...
    pneumonia_ab_type_11=patients.with_these_medications(
        antibacterials_codes_brit,
        between=['pneumonia_date_11','pneumonia_date_11 + 5 days'],
        returning='category',
        return_expectations={"category": {"ratios": {"Doxycycline":0.1, "Cefoxitin":0.05, "Aztreonam":0.05, 
    ...
    pneumonia_ab_type_12=patients.with_these_medications(
        antibacterials_codes_brit,
        between=['pneumonia_date_12','pneumonia_date_12 + 5 days'],
        returning='category',
        return_expectations={"category": {"ratios": {"Doxycycline":0.1, "Cefoxitin":0.05, "Aztreonam":0.05, 
    ...
    pneumonia_ab_type_13=patients.with_these_medications(
        antibacterials_codes_brit,
        between=['pneumonia_date_13','pneumonia_date_13 + 5 days'],
        returning='category',
        return_expectations={"category": {"ratios": {"Doxycycline":0.1, "Cefoxitin":0.05, "Aztreonam":0.05, 
    ...
    pneumonia_ab_type_14=patients.with_these_medications(
        antibacterials_codes_brit,
        between=['pneumonia_date_14','pneumonia_date_14 + 5 days'],
        returning='category',
        return_expectations={"category": {"ratios": {"Doxycycline":0.1, "Cefoxitin":0.05, "Aztreonam":0.05, 
    ...
    pneumonia_ab_type_15=patients.with_these_medications(
        antibacterials_codes_brit,
        between=['pneumonia_date_15','pneumonia_date_15 + 5 days'],
        returning='category',
        return_expectations={"category": {"ratios": {"Doxycycline":0.1, "Cefoxitin":0.05, "Aztreonam":0.05, 
