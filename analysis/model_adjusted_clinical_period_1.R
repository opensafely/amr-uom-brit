...
write_csv(plot1, here::here("output", "adjusted_clinical_1_period_1.csv"))
write_csv(plot2, here::here("output", "adjusted_clinical_2_period_1.csv"))
write_csv(plot3, here::here("output", "adjusted_clinical_3_period_1.csv"))
