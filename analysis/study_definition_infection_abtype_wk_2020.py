...
#---- ot_externa
  ...
  ####### Antibiotics types
    ...
    uti_abtype1=patients.with_these_medications(
        antibacterials_codes_brit,
        between=["uti_date_1 - 7 days","uti_date_1+ 7 days"],
        returning="category",
        return_expectations={
    ...
    urti_abtype1=patients.with_these_medications(
        antibacterials_codes_brit,
        between=["urti_date_1 - 7 days","urti_date_1 + 7 days"],
        returning="category",
        return_expectations={
            "category": {"ratios": {"Amikacin":0.05, "Amoxicillin":0.1, "Azithromycin":0.04, "Cefaclor":0.05,
            "Co-amoxiclav":0.05, "Co-fluampicil":0.05, "Metronidazole":0.05, "Nitrofurantoin":0.05,
    ...
    lrti_abtype1=patients.with_these_medications(
        antibacterials_codes_brit,
        between=["lrti_date_1 - 7 days","lrti_date_1 + 7 days"],
        returning="category",
        return_expectations={
            "category": {"ratios": {"Amikacin":0.05, "Amoxicillin":0.1, "Azithromycin":0.04, "Cefaclor":0.05,
            "Co-amoxiclav":0.05, "Co-fluampicil":0.05, "Metronidazole":0.05, "Nitrofurantoin":0.05,
    ...
    sinusitis_abtype1=patients.with_these_medications(
        antibacterials_codes_brit,
        between=["sinusitis_date_1 - 7 days","sinusitis_date_1 + 7 days"],
        returning="category",
        return_expectations={
            "category": {"ratios": {"Amikacin":0.05, "Amoxicillin":0.1, "Azithromycin":0.04, "Cefaclor":0.05,
            "Co-amoxiclav":0.05, "Co-fluampicil":0.05, "Metronidazole":0.05, "Nitrofurantoin":0.05,
    ...
    otmedia_abtype1=patients.with_these_medications(
        antibacterials_codes_brit,
        between=["otmedia_date_1 - 7 days","otmedia_date_1 + 7 days"],
        returning="category",
        return_expectations={
            "category": {"ratios": {"Amikacin":0.05, "Amoxicillin":0.1, "Azithromycin":0.04, "Cefaclor":0.05,
            "Co-amoxiclav":0.05, "Co-fluampicil":0.05, "Metronidazole":0.05, "Nitrofurantoin":0.05,
    ...
    ot_externa_abtype1=patients.with_these_medications(
        antibacterials_codes_brit,
        between=["ot_externa_date_1 - 7 days","ot_externa_date_1 + 7 days"],
        returning="category",
        return_expectations={
            "category": {"ratios": {"Amikacin":0.05, "Amoxicillin":0.1, "Azithromycin":0.04, "Cefaclor":0.05,
            "Co-amoxiclav":0.05, "Co-fluampicil":0.05, "Metronidazole":0.05, "Nitrofurantoin":0.05,
    ...
    uti_abtype2=patients.with_these_medications(
        antibacterials_codes_brit,
        between=["uti_date_2 - 7 days","uti_date_2 + 7 days"],
        returning="category",
        return_expectations={
            "category": {"ratios": {"Amikacin":0.05, "Amoxicillin":0.1, "Azithromycin":0.04, "Cefaclor":0.05,
            "Co-amoxiclav":0.05, "Co-fluampicil":0.05, "Metronidazole":0.05, "Nitrofurantoin":0.05,
    ...
    urti_abtype2=patients.with_these_medications(
        antibacterials_codes_brit,
        between=["urti_date_2 - 7 days","urti_date_2 + 7 days"],
        returning="category",
        return_expectations={
            "category": {"ratios": {"Amikacin":0.05, "Amoxicillin":0.1, "Azithromycin":0.04, "Cefaclor":0.05,
            "Co-amoxiclav":0.05, "Co-fluampicil":0.05, "Metronidazole":0.05, "Nitrofurantoin":0.05,
    ...
    lrti_abtype2=patients.with_these_medications(
        antibacterials_codes_brit,
        between=["lrti_date_2 - 7 days","lrti_date_2 + 7 days"],
        returning="category",
        return_expectations={
            "category": {"ratios": {"Amikacin":0.05, "Amoxicillin":0.1, "Azithromycin":0.04, "Cefaclor":0.05,
            "Co-amoxiclav":0.05, "Co-fluampicil":0.05, "Metronidazole":0.05, "Nitrofurantoin":0.05,
    ...
    sinusitis_abtype2=patients.with_these_medications(
        antibacterials_codes_brit,
        between=["sinusitis_date_2 - 7 days","sinusitis_date_2 + 7 days"],
        returning="category",
        return_expectations={
            "category": {"ratios": {"Amikacin":0.05, "Amoxicillin":0.1, "Azithromycin":0.04, "Cefaclor":0.05,
            "Co-amoxiclav":0.05, "Co-fluampicil":0.05, "Metronidazole":0.05, "Nitrofurantoin":0.05,
    ...
    otmedia_abtype2=patients.with_these_medications(
        antibacterials_codes_brit,
        between=["otmedia_date_2 - 7 days","otmedia_date_2 + 7 days"],
        returning="category",
        return_expectations={
            "category": {"ratios": {"Amikacin":0.05, "Amoxicillin":0.1, "Azithromycin":0.04, "Cefaclor":0.05,
            "Co-amoxiclav":0.05, "Co-fluampicil":0.05, "Metronidazole":0.05, "Nitrofurantoin":0.05,
    ...
    ot_externa_abtype2=patients.with_these_medications(
        antibacterials_codes_brit,
        between=["ot_externa_date_2 - 7 days","ot_externa_date_2 + 7 days"],
        returning="category",
        return_expectations={
            "category": {"ratios": {"Amikacin":0.05, "Amoxicillin":0.1, "Azithromycin":0.04, "Cefaclor":0.05,
            "Co-amoxiclav":0.05, "Co-fluampicil":0.05, "Metronidazole":0.05, "Nitrofurantoin":0.05,
    ...
    uti_abtype3=patients.with_these_medications(
        antibacterials_codes_brit,
        between=["uti_date_3 - 7 days","uti_date_3 + 7 days"],
        returning="category",
        return_expectations={
            "category": {"ratios": {"Amikacin":0.05, "Amoxicillin":0.1, "Azithromycin":0.04, "Cefaclor":0.05,
            "Co-amoxiclav":0.05, "Co-fluampicil":0.05, "Metronidazole":0.05, "Nitrofurantoin":0.05,
    ...
    urti_abtype3=patients.with_these_medications(
        antibacterials_codes_brit,
        between=["urti_date_3 - 7 days","urti_date_3 + 7 days"],
        returning="category",
        return_expectations={
            "category": {"ratios": {"Amikacin":0.05, "Amoxicillin":0.1, "Azithromycin":0.04, "Cefaclor":0.05,
            "Co-amoxiclav":0.05, "Co-fluampicil":0.05, "Metronidazole":0.05, "Nitrofurantoin":0.05,
    ...
    lrti_abtype3=patients.with_these_medications(
        antibacterials_codes_brit,
        between=["lrti_date_3 - 7 days","lrti_date_3 + 7 days"],
        returning="category",
        return_expectations={
            "category": {"ratios": {"Amikacin":0.05, "Amoxicillin":0.1, "Azithromycin":0.04, "Cefaclor":0.05,
            "Co-amoxiclav":0.05, "Co-fluampicil":0.05, "Metronidazole":0.05, "Nitrofurantoin":0.05,
    ...
    sinusitis_abtype3=patients.with_these_medications(
        antibacterials_codes_brit,
        between=["sinusitis_date_3 - 7 days","sinusitis_date_3 + 7 days"],
        returning="category",
        return_expectations={
            "category": {"ratios": {"Amikacin":0.05, "Amoxicillin":0.1, "Azithromycin":0.04, "Cefaclor":0.05,
            "Co-amoxiclav":0.05, "Co-fluampicil":0.05, "Metronidazole":0.05, "Nitrofurantoin":0.05,
    ...
    otmedia_abtype3=patients.with_these_medications(
        antibacterials_codes_brit,
        between=["otmedia_date_3 - 7 days","otmedia_date_3 + 7 days"],
        returning="category",
        return_expectations={
            "category": {"ratios": {"Amikacin":0.05, "Amoxicillin":0.1, "Azithromycin":0.04, "Cefaclor":0.05,
            "Co-amoxiclav":0.05, "Co-fluampicil":0.05, "Metronidazole":0.05, "Nitrofurantoin":0.05,
    ...
    ot_externa_abtype3=patients.with_these_medications(
        antibacterials_codes_brit,
        between=["ot_externa_date_3 - 7 days","ot_externa_date_3 + 7 days"],
        returning="category",
        return_expectations={
            "category": {"ratios": {"Amikacin":0.05, "Amoxicillin":0.1, "Azithromycin":0.04, "Cefaclor":0.05,
            "Co-amoxiclav":0.05, "Co-fluampicil":0.05, "Metronidazole":0.05, "Nitrofurantoin":0.05,
    ...
    uti_abtype4=patients.with_these_medications(
        antibacterials_codes_brit,
        between=["uti_date_4 - 7 days","uti_date_4 + 7 days"],
        returning="category",
        return_expectations={
            "category": {"ratios": {"Amikacin":0.05, "Amoxicillin":0.1, "Azithromycin":0.04, "Cefaclor":0.05,
            "Co-amoxiclav":0.05, "Co-fluampicil":0.05, "Metronidazole":0.05, "Nitrofurantoin":0.05,
    ...
    urti_abtype4=patients.with_these_medications(
        antibacterials_codes_brit,
        between=["urti_date_4 - 7 days","urti_date_4 + 7 days"],
        returning="category",
        return_expectations={
            "category": {"ratios": {"Amikacin":0.05, "Amoxicillin":0.1, "Azithromycin":0.04, "Cefaclor":0.05,
            "Co-amoxiclav":0.05, "Co-fluampicil":0.05, "Metronidazole":0.05, "Nitrofurantoin":0.05,
    ...
    lrti_abtype4=patients.with_these_medications(
        antibacterials_codes_brit,
        between=["lrti_date_4 - 7 days","lrti_date_4 + 7 days"],
        returning="category",
        return_expectations={
            "category": {"ratios": {"Amikacin":0.05, "Amoxicillin":0.1, "Azithromycin":0.04, "Cefaclor":0.05,
            "Co-amoxiclav":0.05, "Co-fluampicil":0.05, "Metronidazole":0.05, "Nitrofurantoin":0.05,
    ...
    sinusitis_abtype4=patients.with_these_medications(
        antibacterials_codes_brit,
        between=["sinusitis_date_4 - 7 days","sinusitis_date_4 + 7 days"],
        returning="category",
        return_expectations={
            "category": {"ratios": {"Amikacin":0.05, "Amoxicillin":0.1, "Azithromycin":0.04, "Cefaclor":0.05,
            "Co-amoxiclav":0.05, "Co-fluampicil":0.05, "Metronidazole":0.05, "Nitrofurantoin":0.05,
    ...
    otmedia_abtype4=patients.with_these_medications(
        antibacterials_codes_brit,
        between=["otmedia_date_4 - 7 days","otmedia_date_4 + 7 days"],
        returning="category",
        return_expectations={
            "category": {"ratios": {"Amikacin":0.05, "Amoxicillin":0.1, "Azithromycin":0.04, "Cefaclor":0.05,
            "Co-amoxiclav":0.05, "Co-fluampicil":0.05, "Metronidazole":0.05, "Nitrofurantoin":0.05,
    ...
    ot_externa_abtype4=patients.with_these_medications(
        antibacterials_codes_brit,
        between=["ot_externa_date_4 - 7 days","ot_externa_date_4 + 7 days"],
        returning="category",
        return_expectations={
            "category": {"ratios": {"Amikacin":0.05, "Amoxicillin":0.1, "Azithromycin":0.04, "Cefaclor":0.05,
            "Co-amoxiclav":0.05, "Co-fluampicil":0.05, "Metronidazole":0.05, "Nitrofurantoin":0.05,
