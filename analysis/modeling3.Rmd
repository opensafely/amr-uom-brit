...
df$ab_qn_5=as.character(df$ab_qn_5) #category
...
mod=clogit(case ~ ab_qn + CCI + covrx_ever + bmi_cat + care_home + flu_vaccine + smoking_cat_3 + imd+ ethnicity_6 + strata(subclass), df)
summary(mod)
vif(mod)
