...
```{r}
mod1=clogit(case ~ level+lastABtime + strata(subclass), df)
summary(mod1)
vif(mod1)
```
...
mod3=clogit(case ~ level + lastABtime+ CCI + covrx_ever + bmi_cat + care_home + flu_vaccine + smoking_cat_3 + imd+ ethnicity_6 + strata(subclass), df)
summary(mod3)
vif(mod3)
