...
DF3$total_check=DF3$total_ab_yr1+DF3$total_ab_yr2+DF3$total_ab_yr3+DF3$total_ab_yr3_15d
...
```{r}
check=DF3[DF3$total_check==0 & DF3$total_ab != 0,]
length(as.factor(check$patient_id))
```
