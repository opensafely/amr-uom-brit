...
plot(roc(train_X$case~ pred.y),main="ROC curves for four models predicting case")#black
plot(roc(train_X$case~ pred.y2),col=2,add=T)#red
plot(roc(train_X$case~ pred.y3),col=3,add=T)#green
plot(roc(train_X$case~ pred.y4),col=4,add=T)#blue
plot(roc(train_X$case~ pred.y5),col=4,add=T)#blue

print(roc(train_X$case~ pred.y)
print(roc(train_X$case~ pred.y2)
print(roc(train_X$case~ pred.y3)
print(roc(train_X$case~ pred.y4)
print(roc(train_X$case~ pred.y5)
...
plot(roc(valid_X$case~ pred.y),main="ROC curves for four models predicting case")#black
plot(roc(valid_X$case~ pred.y2),col=2,add=T)#red
plot(roc(valid_X$case~ pred.y3),col=3,add=T)#green
plot(roc(valid_X$case~ pred.y4),col=4,add=T)#blue
plot(roc(valid_X$case~ pred.y5),col=4,add=T)#blue

print(roc(valid_X$case~ pred.y)
print(roc(valid_X$case~ pred.y2)
print(roc(valid_X$case~ pred.y3)
print(roc(valid_X$case~ pred.y4)
print(roc(valid_X$case~ pred.y5)
```
