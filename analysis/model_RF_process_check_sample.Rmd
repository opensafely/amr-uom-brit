...
DF=DF%>% select("patient_id","patient_index_date","case","age","wave","sex","age_cat","region")
count(DF)
table(DF$case)
...
table(DF_uniq$sex,DF_uniq$case) 
table(DF_uniq$region,DF_uniq$case)
