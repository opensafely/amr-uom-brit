...
devel.all=merge(train, devel, by=c("patient_index_date","patient_id"), all.x=TRUE)
...
saveRDS(devel.all,here::here("output","development.rds"))
saveRDS(valid.all,here::here("output","validation.rds"))
