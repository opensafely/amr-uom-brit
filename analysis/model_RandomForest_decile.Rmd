...
col=c("patient_id","patient_index_date","case","sex","age","region","wave","total_ab","ab_types","exposure_period" ,"recent_ab_days", "broad_prop" ,"interval_mean" , "interval_CV",abtype)
