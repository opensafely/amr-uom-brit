...
df <- read_rds(here::here("output","matched_outcome_study2.rds"))
...
write.csv(model,here::here("output","model_1_crude_study2.csv"))
...
write.csv(model,here::here("output","model_1_adjusted_study2.csv"))
