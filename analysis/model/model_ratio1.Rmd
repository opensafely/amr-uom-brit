...
df <- read_rds(here::here("output","development_ratio1.rds"))
table(df$decile)
table(df$case)
...
#saveRDS(model,here::here("output","model_ratio1.rds"))
...
#saveRDS(model,here::here("output","model_adj_ratio1.rds"))
...
#saveRDS(model,here::here("output","model_adj_all_ratio1.rds"))
...
```{r}
rm(df)
df <- read_rds(here::here("output","validation_ratio1.rds"))
table(df$decile)
table(df$case)
prop.table(table(df$case,df$decile))
