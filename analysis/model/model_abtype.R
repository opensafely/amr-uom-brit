...
p <- ggplot(data=DF, aes(y=AB_exposure, x=OR))+ 
  ...
  annotate("text", x = 0.8, y =1, label = "Q1")+
  annotate("text", x = 0.8, y =2.5, label = "Q2")+
  annotate("text", x = 0.8, y =5, label = "Q3")+
  annotate("text", x = 0.8, y =8, label = "Q4")+
  annotate("text", x = 0.8, y =11, label = "Q5")+
