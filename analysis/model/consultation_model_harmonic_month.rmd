...
df5$month=as.numeric(df5$month)
df6$month=as.numeric(df6$month)
...
##UTI
```{r}
summary(m1 <- glm.nb(counts~ offset(log(population))+ covid + harm(month,2,12) +times , data = df1))
```

## URTI
```{r}
summary(m2 <- glm.nb(counts~ offset(log(population))+ covid + harm(month,2,12) +times , data = df2))
```

## LRTI
```{r}
summary(m3 <- glm.nb(counts~ offset(log(population))+ covid +  harm(month,2,12) +times , data = df3))
```

## Sinusitis
```{r}
summary(m4 <- glm.nb(counts~ offset(log(population))+ covid +  harm(month,2,12) +times , data = df4))
```

## otitis externa
```{r}
summary(m5 <- glm.nb(counts~ offset(log(population))+ covid + harm(month,2,12) +times , data = df5))

```

## otitis media
```{r}
summary(m6 <- glm.nb(counts~ offset(log(population))+ covid +  harm(month,2,12) +times , data = df6))
```
...
## UTI
```{r}
summary(m1.1 <- glm.nb(counts~ offset(log(population))+ covid +  harm(month,2,12) + times + times*covid  , data = df1))
```

## URTI
```{r}
summary(m2.1 <- glm.nb(counts~ offset(log(population))+ covid +  harm(month,2,12)+ times + times*covid  , data = df2))
```

## LRTI
```{r}
summary(m3.1 <- glm.nb(counts~ offset(log(population))+ covid + harm(month,2,12) + times + times*covid  , data = df3))
```

## sinusitis
```{r}
summary(m4.1 <- glm.nb(counts~ offset(log(population))+ covid + harm(month,2,12) + times + times*covid  , data = df4))
```

## otitis externa
```{r}
summary(m5.1 <-glm.nb(counts~ offset(log(population))+ covid + harm(month,2,12) + times + times*covid  , data = df5))
```

## otitis media
```{r }
summary(m6.1 <- glm.nb(counts~ offset(log(population))+ covid + harm(month,2,12) + times + times*covid  , data = df6))
```
