...
```{r message=FALSE}
m1.1=glm.nb(counts~ offset(log(population))+ covid + month + times + times*covid  , data = df1)
m2.1=glm.nb(counts~ offset(log(population))+ covid + month + times + times*covid  , data = df2)
m3.1=glm.nb(counts~ offset(log(population))+ covid + month + times + times*covid  , data = df3)
m4.1=glm.nb(counts~ offset(log(population))+ covid + month + times + times*covid  , data = df4)
m5.1=glm.nb(counts~ offset(log(population))+ covid + month + times + times*covid  , data = df5)
m6.1=glm.nb(counts~ offset(log(population))+ covid + month + times + times*covid  , data = df6)
