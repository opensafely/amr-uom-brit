...
## UTI
```{r}
summary(m1.2 <- glm.nb(counts~ offset(log(population))+ covid + month + times + times*covid + residuals , data = df1))
```

## URTI
```{r}
summary(m2.2 <- glm.nb(counts~ offset(log(population))+ covid + month + times + times*covid + residuals , data = df2))
```

## LRTI
```{r}
summary(m3.2 <- glm.nb(counts~ offset(log(population))+ covid + month + times + times*covid + residuals , data = df3))
```

## sinusitis
```{r}
summary(m4.2 <- glm.nb(counts~ offset(log(population))+ covid + month + times + times*covid + residuals , data = df4))
```

## otitis externa
```{r}
summary(m5.2 <- glm.nb(counts~ offset(log(population))+ covid + month + times + times*covid + residuals , data = df5))
```

## otitis media
```{r}
summary(m6.2 <- glm.nb(counts~ offset(log(population))+ covid + month + times + times*covid + residuals , data = df6))
```
