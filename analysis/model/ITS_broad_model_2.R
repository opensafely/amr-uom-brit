...
its_function <- function(outcomes_vec = outcomes,
  ...
  write_csv(main_plot_data, here::here("output", "its_main_plot_data_2.csv"))
  ...
  ggsave(
    plot= plot1,
    filename="predicted_plot_2.jpeg", path=here::here("output"),
  )  
  ...
  write_csv(forest_plot_df, here::here("output", "its_main_ORs_2.csv"))
  ...
  ggsave(
    plot= fp,
    filename="forest_plot_broad_2.jpeg", path=here::here("output"),
  )  
