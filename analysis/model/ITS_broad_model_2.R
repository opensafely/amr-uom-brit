...
its_function <- function(outcomes_vec = outcomes,
  ...
  plot_its <- function(outcome){
    ...
    write_csv(main_plot_data, here::here("output", "its_main_plot_data_without_A.csv"))
    ...
    write_csv(forest_plot_df, here::here("output", "its_main_ORs_without_A.csv"))
...
ggsave(
  plot= fp,
  filename="forest_plot_broad_without_A.jpeg", path=here::here("output"),
)  
