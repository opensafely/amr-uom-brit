...
df <- read_rds(here::here("output","development_hosp.rds"))
table(df$decile)
table(df$case)
...
saveRDS(model,here::here("output","model_hosp.rds"))
...
saveRDS(model,here::here("output","model_adj_hosp.rds"))
...
saveRDS(model,here::here("output","model_adj_all_hosp.rds"))
...
```{r}
rm(df)
df <- read_rds(here::here("output","validation_hosp.rds"))
table(df$decile)
table(df$case)
prop.table(table(df$case,df$decile))
