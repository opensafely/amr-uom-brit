---
title: "ITS - infections with issued antibiotics % "
output: 
  html_document:
   toc: true
   toc_depth: 2
...
# %
df$value=1-df$percentage # calculate indication with ab
...
Incident UTI consultations with antibiotics 
```{r}
...
Incident URTI consultations with antibiotics 
```{r}
...
Incident LRTI consultations with antibiotics 
```{r}
...
Incident Sinusitis consultations with antibiotics 
```{r}
...
Incident Otitis externa consultations with antibiotics 
```{r}
...
Incident Otitis media consultations with antibiotics 
...
Prevalent UTI consultations with antibiotics 
```{r}
...
Prevalent URTI consultations with antibiotics 
```{r}
...
Prevalent LRTI consultations with antibiotics 
```{r}
...
Prevalent Sinusitis consultations with antibiotics 
```{r}
...
Prevalent Otitis externa consultations with antibiotics 
```{r}
...
Prevalent Otitis media consultations with antibiotics 
...
## result- ITS Plot
 ...
 UTI consultations with antibiotics 
```{r}
...
```
 ...
 URTI consultations with antibiotics 
```{r}
...
```
 ...
 LRTI consultations with antibiotics 
```{r}
...
```
 ...
 Sinusitis consultations with antibiotics 
```{r}
...
```
 ...
 Otitis externa consultations with antibiotics 
```{r}
...
```
 ...
 Otitis media consultations with antibiotics 
