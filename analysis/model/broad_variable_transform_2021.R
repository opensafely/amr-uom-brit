...
df_input <- read_rds('basic_record_2021.rds')
...
saveRDS(df, "model_variable_broad_2021_1.rds")
...
write_csv(overall_counts, here::here("output", "model_varibale_overall_count_2021.csv"))
...
#str(t)
write_csv(t, here::here("output", "model_varibale_table_2021.csv"))