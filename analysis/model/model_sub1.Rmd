...
df$recent_ab_days_group= relevel(as.factor(df$df$recent_ab_days_group), ref="1")
...
model=clogit(case ~ total_ab_group + df$recent_ab_days_group + total_ab_group*recent_ab_days_group+ strata(subclass),df) 
