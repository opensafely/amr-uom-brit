...
# cross table
```{r}
table(df$total_ab_group,df$recent_ab_days_group)
table(df$total_ab_group,df$exposure_period_group)
table(df$total_ab_group,df$interval_mean_group)
table(df$total_ab_group,df$interval_sd_group)
table(df$total_ab_group,df$ab_types_group)
table(df$total_ab_group,df$broad_ab_prescriptions_group)
