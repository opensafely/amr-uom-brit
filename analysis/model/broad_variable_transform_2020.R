...
saveRDS(df, "model_variable_broad_2020_1.rds")
##outcome check
...
write_csv(overall_counts, here::here("output", "model_varibale_overall_count_2020.csv"))
...
#str(t)
write_csv(t, here::here("output", "model_varibale_table_2020.csv"))