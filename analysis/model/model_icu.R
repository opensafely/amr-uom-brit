...
df <- read_rds(here::here("output","matched_outcome_icu.rds"))
...
write.csv(model,here::here("output","model_1_crude_icu.csv"))
...
write.csv(model,here::here("output","model_1_adjusted_icu.csv"))
