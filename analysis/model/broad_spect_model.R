# ##This script use the records from Jan 2019 to Dec 2019 to fit the pre_covid_model
...
df_input <- df_input %>% select(died_date,age,age_cat,sex,practice,msoa,bmi,region,
                                ethnicity,gp_count,flu_vaccine,antibacterial_12mb4,cancer_comor,
                                cardiovascular_comor,chronic_obstructive_pulmonary_comor,    
                                heart_failure_comor,connective_tissue_comor,dementia_comor,diabetes_comor,                          
                                diabetes_complications_comor,hemiplegia_comor,hiv_comor,metastatic_cancer_comor,
                                mild_liver_comor,mod_severe_liver_comor,                  
...
df <- select(df_input, date, patient_id, practice, age_cat, bmi, 
             bmi_cat, ethnicity_6, charlson_score, charlsonGrp, flu_vaccine, imd, antibacterial_12mb4, gp_count) 
rm(df_input)
