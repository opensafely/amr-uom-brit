...
df7$rate=df7$counts/df7$population
...
ggplot(df1, aes(x=date, y=rate, group=covid)) + 
  theme_bw()+
  annotate(geom = "rect", xmin = as.Date("2019-01-01"),xmax = as.Date("2019-12-01"),ymin = -Inf, ymax = Inf,fill="grey80", alpha=0.5)+
 ...
 geom_smooth(method="lm", se=FALSE, fullrange=FALSE, level=0.95, color="black")+
