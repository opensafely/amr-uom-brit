...
df1 <- read.csv(here::here("output","case_covid_icu_death.csv"))
df1$case=1
df2 <- read.csv(here::here("output","control_covid_hosp.csv"))
df2$case=0
...
df0=df0%>% select("case","wave","sex","age","region")
...
df1=df1%>% select("case","wave","sex","age","age_cat","region")
