...
explanatory<- c("exposure_period_group","recent_ab_days_group","interval_mean_group","interval_sd_group","ab_types_group","broad_ab_prescriptions_group")
...
ggsave(
   plot= p,
   filename="fig4-1.png", path=here::here("output"), dpi = 300,
)
```
...
ggsave(
   plot= p,
   filename="fig4-2.png", path=here::here("output"), dpi = 300,
)
```
...
ggsave(
   plot= p,
   filename="fig4-3.png", path=here::here("output"), dpi = 300,
)
```
...
ggsave(
   plot= p,
   filename="fig4-4.png", path=here::here("output"), dpi = 300,
)
```
...
ggsave(
   plot= p,
   filename="fig4-5.png", path=here::here("output"), dpi = 300,
)
```
...
ggsave(
   plot= p,
   filename="fig4-6.png", path=here::here("output"), dpi = 300,
)
```