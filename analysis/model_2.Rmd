...
labs(
    title = "Total antibiotics*Exposure period(days)",
    x="",
    y=""
  )
p
...
labs(
    title = "Total antibiotics*Recent Antibiotics(days)",
    x="",
    y=""
  )
p
...
annotate(geom = "rect", xmin = -Inf,xmax = Inf,ymin = 8, ymax = 11.5,fill="grey80", alpha=0.5)+
  ...
  annotate("text", x = 0.1, y =13.5, label = "very high",size=3)+
   ...
   geom_text(size=3,aes(y = 1:15, x = 0.5, 
               label = c("1"="Level2","2"="Level3","3"="Level4","4"="Level1","5"="Level2","6"="Level3","7"="Level4","8"="Level1","9"="Level2","10"="Level3","11"="Level4","12"="Level1","13"="Level2","14"="Level3","15"="Level4*")),
           hjust = "right",
           nudge_y = -.1)+
...
labs(
    title = "Total antibiotics*Prescribing intervals (mean)",
    x="",
    y=""
  )
p
...
annotate(geom = "rect", xmin = -Inf,xmax = Inf,ymin = 7.5, ymax = 11.5,fill="grey80", alpha=0.5)+
    ...
    annotate("text", x = 0.6, y =2.5, label = "low",size=3)+
  annotate("text", x = 0.6, y =5.5, label = "high",size=3)+
  annotate("text", x = 0.6, y =9.5, label = "very high",size=3)+

   geom_text(size=3,aes(y = 1:12, x = 0.9, 
               label = c("5"="Level1","6"="Level2","7"="Level3","8"="Level4","9"="Level1*","10"="Level2","11"="Level3","12"="Level4","13"="Level1*","14"="Level2","15"="Level3","16"="Level4")),
           hjust = "right",
           nudge_y = -.1)+
...
labs(
    title = "Total antibiotics*Prescribing intervals (SD)",
    x="",
    y=""
  )
p
 ...
 #   annotate("text", x = 0.6, y =2, label = "very low")+
  ...
  annotate("text", x = 0.1, y =8, label = "very high",size=3)+
   ...
   geom_text(size=3,aes(y = 1:9, x = 0.9, 
               label = c("5"="Level1","7"="Level2","8"="Level3","9"="Level1","11"="Level2","12"="Level3","13"="Level1","15"="Level2","16"="Level3")),
           hjust = "right",
           nudge_y = -.1)+
...
labs(
    title = "Total Antibiotics*Antibiotic types",
    x="",
    y=""
  )
p
...
labs(
    title = "Total Antibiotics*Broad-spectrum antibiotics",
    x="",
    y=""
  )
p
