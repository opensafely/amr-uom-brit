...
# total ab level 1
df1$explanatory[i] <- ifelse(df1$contd[i] <= Q1[1], 1,
                             ifelse(df1$contd[i] > Q1[1] & df1$contd[i] <= Q2[1], 2,
                                    ifelse(df1$contd[i] > Q2[1] & df1$contd[i] <= Q3[1], 3,
                                           ifelse(df1$contd[i] > Q3[1], 4, NA))))
