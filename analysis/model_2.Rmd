...
annotate(geom = "rect", xmin = -Inf,xmax = Inf,ymin = 9.5, ymax = 12.5,fill="grey80", alpha=0.5)+
    annotate("text", x = 0.6, y =2.5, label = "very low")+
    annotate("text", x = 0.6, y =6.5, label = "low")+
  annotate("text", x = 0.6, y =10.5, label = "high")+
  annotate("text", x = 0.6, y =14.5, label = "very high")+
