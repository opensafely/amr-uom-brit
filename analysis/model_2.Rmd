...
setDT(DF, keep.rownames = TRUE)[]
names(DF)[1]="AB_exposure"
DF$AB_exposure=factor(DF$AB_exposure,levels=c("ab_Level_type1","ab_Level_type2","ab_Level_type5","ab_Level_type7","ab_Level_type8","ab_Level_type9","ab_Level_type10","ab_Level_type11","ab_Level_type12","ab_Level_type13","ab_Level_type14","ab_Level_type15")) # remove 3,4,6
...
setDT(DF, keep.rownames = TRUE)[]
names(DF)[1]="AB_exposure"
DF$AB_exposure=factor(DF$AB_exposure,levels=c("ab_Level_type1","ab_Level_type4","ab_Level_type5","ab_Level_type8","ab_Level_type9","ab_Level_type11","ab_Level_type12","ab_Level_type13","ab_Level_type15","ab_Level_type16"))
  ...
  annotate("text", x = 0.1, y =8, label = "Very High",size=3)+
   ...
   geom_text( size=3,aes(y = 1:9, x = 0.7,
               label = c(#"1"=paste0("Level2 (",Q2[1],")"),
                       # "2"= paste0("Level3 (",Q2[3],")"),
                      #  "3"= paste0("Level4 (",Q2[4],")"),
                        "1"= paste0("Level1 (",Q2[2],")"),
                        "2"= paste0("Level2 (",Q2[3],")"),
                      #  "6"= paste0("Level3 (",Q2[7],")"),
                      #  "7"= paste0("Level4 (",Q2[8],")"),
                        "3"= paste0("Level1 (",Q2[4],")"),
                        "4"= paste0("Level2 (",Q2[5],")"),
                      #  "10"= paste0("Level3 (",Q2[11],")"),
                        "5"= paste0("Level4 (",Q2[6],")"),
                        "6"= paste0("Level1 (",Q2[7],")"),
                        "7"= paste0("Level2 (",Q2[8],")"),
                      #  "14"= paste0("Level3 (",Q2[15],")"),
                        "8"= paste0("Level4 (",Q2[9],")"),
                         "9"= paste0("Level4 (",Q2[10],")"))),
           hjust = "right",
           nudge_y = -.1)+
