...
df2$exposure_period_group=ifelse(
  df2$exposure_period <= Q1[2],1, ifelse(
    df2$exposure_period > Q1[2] & df1$exposure_period <= Q2[2], 2, ifelse(
      df2$expoure_period > Q2[2] & df1$exposure_period <= Q3[2], 3, 4
    )
  )
)
...
df3$exposure_period_group=ifelse(
  df3$exposure_period <= Q1[3],1, ifelse(
    df3$exposure_period > Q1[3] & df1$exposure_period <= Q2[3], 2, ifelse(
      df3$expoure_period > Q2[3] & df1$exposure_period <= Q3[3], 3, 4
    )
  )
)
...
df4$exposure_period_group=ifelse(
  df4$exposure_period <= Q1[4],1, ifelse(
    df4$exposure_period > Q1[4] & df1$exposure_period <= Q2[4], 2, ifelse(
      df4$expoure_period > Q2[4] & df1$exposure_period <= Q3[4], 3, 4
    )
  )
)
