...
df1=df1%>%mutate(exposure_period_group=
                   case_when(
                     ...
                     exposure_period > Q2[1] & df1$exposure_period <= Q3[1] ~ "3",
...
annotate(geom = "rect", xmin = -Inf,xmax = Inf,ymin = 7.5, ymax = 11.5,fill="grey80", alpha=0.5)+
  ...
  annotate("text", x = 0.1, y =13.5, label = "Very High",size=3)+
   ...
   geom_text( size=3,aes(y = 1:15, x = 0.7,
               label = c("1"="Level2 (423)","2"="Level3 (728)","3"="Level4 (977)","4"="Level1 (75)","5"="Level2 (423)","6"="Level3 (728)","7"="Level4 (977)","8"="Level1 (75)","9"="Level2 (423)","10"="Level3 (728)","11"="Level4 (977)","12"="Level1 (75)","13"="Level2 (423)","14"="Level3 (728)","15"="Level4 (977)")),
           hjust = "right",
           nudge_y = -.1)+
